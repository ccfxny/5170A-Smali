...
.method static lookUpFactoryClassName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 265
    .local v11, "ss":Lorg/apache/xpath/functions/SecuritySupport;
    :try_start_0
    move-object/from16 v0, p0

    invoke-virtual {v11, v0}, Lorg/apache/xpath/functions/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v14}, Lorg/apache/xpath/functions/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/SecurityException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v11, v14}, Lorg/apache/xpath/functions/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_2
    invoke-virtual {v11, v8}, Lorg/apache/xpath/functions/SecuritySupport;->getFileExists(Ljava/io/File;)Z
    :try_end_2
    ...
    :goto_1
    const-class v15, Lorg/apache/xpath/functions/ObjectFactory;
    ...
    :try_start_3
    sget-wide v16, Lorg/apache/xpath/functions/ObjectFactory;->fLastModified:J
    ...
    invoke-virtual {v11, v7}, Lorg/apache/xpath/functions/SecuritySupport;->getLastModified(Ljava/io/File;)J

    move-result-wide v18

    sput-wide v18, Lorg/apache/xpath/functions/ObjectFactory;->fLastModified:J
    ...
    sput-object v14, Lorg/apache/xpath/functions/ObjectFactory;->fXalanProperties:Ljava/util/Properties;

    .line 321
    invoke-virtual {v11, v7}, Lorg/apache/xpath/functions/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;

    move-result-object v4

    .line 322
    sget-object v14, Lorg/apache/xpath/functions/ObjectFactory;->fXalanProperties:Ljava/util/Properties;
    ...
    sput-wide v14, Lorg/apache/xpath/functions/ObjectFactory;->fLastModified:J
    ...
    :try_start_6
    sput-wide v16, Lorg/apache/xpath/functions/ObjectFactory;->fLastModified:J
    ...
    invoke-virtual {v11, v14}, Lorg/apache/xpath/functions/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
