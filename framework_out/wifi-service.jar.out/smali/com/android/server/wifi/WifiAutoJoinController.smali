...
.field private static final BAD_RSSI_THRESHOLD_24G:I = -0x5a

.field private static final BAD_RSSI_THRESHOLD_5G:I = -0x55
...
.method private compareNetwork(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)I
    ...
    iget-boolean v2, v2, Lcom/android/server/wifi/WifiConfigStore;->enableAutoJoinExtended:Z
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/server/wifi/WifiAutoJoinController;->isBadCandidate(II)Z
    ...
    const-string v3, "compareNetwork: candidate "
    ...
    const-string v3, " has low RSSI, order -20 -> "
    ...
    .line 451
    :cond_6
    iget v2, p1, Landroid/net/wifi/WifiConfiguration;->numNoInternetAccessReports:I
    ...
    const-string v3, " has no InternetAccess, order-85 ->"
    ...
    const-string v3, " has no InternetAccess, last selected -100 -> "
    ...
    const-string v3, "compareNetwork: currentNetwork "
    ...
    .line 475
    :cond_9
    iget v2, v0, Landroid/net/wifi/WifiConfiguration;->numNoInternetAccessReports:I
    ...
    .line 493
    :cond_b
    invoke-direct {p0, v0, p1}, Lcom/android/server/wifi/WifiAutoJoinController;->shouldSwitchNetworkExtended(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiConfiguration;)Z
    ...
    const-string v3, "compareNetwork: shouldSwitchNetworkExtended, order +150 -> "
    ...
    const-string v3, "compareNetwork: -50 to prevent network switching -> "
...
.method private isPriorNetwork(Landroid/net/wifi/WifiConfiguration;)Z
    .locals 2
...
.method private penalizeOnBadNetwork(Landroid/net/wifi/WifiConfiguration;II)I
    .locals 3
    .param p1, "config"    # Landroid/net/wifi/WifiConfiguration;
    .param p2, "order"    # I
    .param p3, "holder"    # I
    ...
    const-string v2, "Checking on low RSSI and internet access: "
    ...
    const-string v2, "No InternetAccess: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p1, Landroid/net/wifi/WifiConfiguration;->validatedInternetAccess:Z
...
.method private shouldSwitchNetworkExtended(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiConfiguration;)Z
    .locals 3
    ...
    .line 1440
    iget v1, p2, Landroid/net/wifi/WifiConfiguration;->numNoInternetAccessReports:I
    ...
    iget-object v2, p2, Landroid/net/wifi/WifiConfiguration;->visibility:Landroid/net/wifi/WifiConfiguration$Visibility;

    iget v2, v2, Landroid/net/wifi/WifiConfiguration$Visibility;->rssi24:I

    invoke-virtual {p0, v1, v2}, Lcom/android/server/wifi/WifiAutoJoinController;->isBadCandidateExtended(II)Z
    ...
    const-string v1, "shouldSwitchNetworkExtended: false, due to bad candidate"
    ...
    const-string v0, "shouldSwitchNetworkExtended: true due to bad current network"
...
.method attemptAutoJoin()Z
    ...
    .line 1513
    const-string v51, "status is null"
    ...
    invoke-interface/range {v51 .. v51}, Lcom/mediatek/common/wifi/IWifiFwkExt;->hasNetworkSelection()I
    ...
    const-string v52, "attemptAutoJoin compared candidate  "
    ...
    iget-boolean v0, v0, Lcom/android/server/wifi/WifiConfigStore;->enableAutoJoinExtended:Z
    ...
    invoke-direct {v0, v9, v1, v2}, Lcom/android/server/wifi/WifiAutoJoinController;->penalizeOnBadNetwork(Landroid/net/wifi/WifiConfiguration;II)I
    ...
    const-string v52, ", adjusted order->"
    ...
    invoke-direct {v0, v11, v1, v2}, Lcom/android/server/wifi/WifiAutoJoinController;->penalizeOnBadNetwork(Landroid/net/wifi/WifiConfiguration;II)I
    ...
    const-string v52, " because candidate is the last selected -> "
    ...
    const-string v52, "attemptAutoJoin: candidate "
    ...
    const-string v52, " has low RSSI, order +20 -> "
    ...
    const-string v52, " has no InternetAccess, order +85 -> "
    ...
    const-string v52, "attemptAutoJoin: config "
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/wifi/WifiStateMachine;->shouldSwitchNetwork(ILjava/lang/String;)Z
    ...
    const-string v51, "wifi.dbg.autojoin"
    ...
    const-string v53, "Auto Connect to "
    ...
    invoke-virtual/range {v51 .. v53}, Lcom/android/server/wifi/WifiStateMachine;->shouldSwitchNetwork(ILjava/lang/String;)Z
...
.method isBadCandidateExtended(II)Z
    .locals 1
    .param p1, "rssi5"    # I
    .param p2, "rssi24"    # I
