...
# static fields
.field private static final LONGEST_FIRST:Ljava/util/Comparator;
...
.field private static final SHORTEST_FIRST:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Comparator",
            "<",
...
.method private static getHostByAddrImpl(Ljava/net/InetAddress;)Ljava/net/InetAddress;
    ...
    sget v3, Landroid/system/OsConstants;->NI_NUMERICHOST:I
...
.method private static lookupHostByName(Ljava/lang/String;I)[Ljava/net/InetAddress;
    ...
    .line 463
    .end local v5    # "gaiException":Landroid/system/GaiException;
    .restart local v1    # "addresses":[Ljava/net/InetAddress;
    .restart local v2    # "arr$":[Ljava/net/InetAddress;
    .restart local v6    # "hints":Landroid/system/StructAddrinfo;
    ...
    :try_end_1
    .catch Landroid/system/GaiException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .end local v7    # "i$":I
    .end local v8    # "len$":I
    .restart local v5    # "gaiException":Landroid/system/GaiException;
    :cond_4
