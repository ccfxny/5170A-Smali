...
.method private static splitAndAdd(Ljava/lang/String;ZLjava/util/ArrayList;)V
    ...
    invoke-interface {v6, v4}, Llibcore/io/Os;->stat(Ljava/lang/String;)Landroid/system/StructStat;

    move-result-object v5

    .line 191
    .local v5, "sb":Landroid/system/StructStat;
    if-eqz p1, :cond_2
    ...
    .line 188
    .end local v5    # "sb":Landroid/system/StructStat;
    :cond_3
    :goto_1
    ...
    .line 195
    .local v2, "ignored":Landroid/system/ErrnoException;
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "stat file error, path is "
