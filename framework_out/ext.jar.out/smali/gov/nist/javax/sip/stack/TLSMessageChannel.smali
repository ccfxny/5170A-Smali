...
.method public processMessage(Lgov/nist/javax/sip/message/SIPMessage;)V
    ...
    const-string v6, ">>> Dropped Bad Msg"
    ...
    .line 454
    .local v18, "sipRequest":Lgov/nist/javax/sip/message/SIPRequest;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v18 .. v18}, Lgov/nist/javax/sip/message/SIPRequest;->getSize()I

    move-result v6

    invoke-virtual/range {v18 .. v18}, Lgov/nist/javax/sip/message/SIPRequest;->getContentLength()Ljavax/sip/header/ContentLengthHeader;
    ...
    .line 473
    .local v19, "sipResponse":Lgov/nist/javax/sip/message/SIPResponse;
    ...
    invoke-direct {v0, v15, v5}, Lgov/nist/javax/sip/stack/TLSMessageChannel;->sendMessage([BZ)V

    .line 475
    new-instance v5, Ljava/lang/Exception;

    const-string v6, "Message size exceeded"
    ...
    .end local v18    # "sipRequest":Lgov/nist/javax/sip/message/SIPRequest;
    .end local v19    # "sipResponse":Lgov/nist/javax/sip/message/SIPResponse;
    .end local v24    # "viaList":Lgov/nist/javax/sip/header/ViaList;
    :catchall_0
    move-exception v5
    ...
    .restart local v24    # "viaList":Lgov/nist/javax/sip/header/ViaList;
    :catch_0
    move-exception v12
    ...
    .restart local v18    # "sipRequest":Lgov/nist/javax/sip/message/SIPRequest;
    :cond_8
    invoke-virtual/range {v18 .. v18}, Lgov/nist/javax/sip/message/SIPRequest;->getContentLength()Ljavax/sip/header/ContentLengthHeader;
    ...
    .line 482
    .local v20, "sipServerRequest":Lgov/nist/javax/sip/stack/ServerRequestInterface;
    if-eqz v20, :cond_b
    ...
    .line 488
    .local v22, "sipServerTx":Lgov/nist/javax/sip/stack/SIPServerTransaction;
    invoke-virtual/range {v22 .. v22}, Lgov/nist/javax/sip/stack/SIPServerTransaction;->passToListener()Z
    ...
    .end local v20    # "sipServerRequest":Lgov/nist/javax/sip/stack/ServerRequestInterface;
    invoke-virtual/range {v20 .. v20}, Lgov/nist/javax/sip/stack/SIPTransaction;->releaseSem()V

    goto/16 :goto_0

    .line 486
    .end local v22    # "sipServerTx":Lgov/nist/javax/sip/stack/SIPServerTransaction;
    .restart local v20    # "sipServerRequest":Lgov/nist/javax/sip/stack/ServerRequestInterface;
    :catchall_1
    move-exception v5
    ...
    .line 488
    .restart local v22    # "sipServerTx":Lgov/nist/javax/sip/stack/SIPServerTransaction;
    invoke-virtual/range {v22 .. v22}, Lgov/nist/javax/sip/stack/SIPServerTransaction;->passToListener()Z
    ...
    .line 496
    .local v16, "response":Lgov/nist/javax/sip/message/SIPResponse;
    new-instance v17, Lgov/nist/javax/sip/header/RetryAfter;

    invoke-direct/range {v17 .. v17}, Lgov/nist/javax/sip/header/RetryAfter;-><init>()V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    .line 500
    .local v17, "retryAfter":Lgov/nist/javax/sip/header/RetryAfter;
    ...
    .line 501
    invoke-virtual/range {v16 .. v17}, Lgov/nist/javax/sip/message/SIPResponse;->setHeader(Ljavax/sip/header/Header;)V
    ...
    const-string v6, "Dropping message -- could not acquire semaphore"
    ...
    .line 511
    .end local v16    # "response":Lgov/nist/javax/sip/message/SIPResponse;
    .end local v17    # "retryAfter":Lgov/nist/javax/sip/header/RetryAfter;
    .end local v18    # "sipRequest":Lgov/nist/javax/sip/message/SIPRequest;
    .end local v20    # "sipServerRequest":Lgov/nist/javax/sip/stack/ServerRequestInterface;
    :cond_c
    move-object/from16 v0, p1
    ...
    .line 513
    .restart local v19    # "sipResponse":Lgov/nist/javax/sip/message/SIPResponse;
    :try_start_8
    invoke-virtual/range {v19 .. v19}, Lgov/nist/javax/sip/message/SIPResponse;->checkHeaders()V
    :try_end_8
    ...
    invoke-virtual/range {v19 .. v19}, Lgov/nist/javax/sip/message/SIPResponse;->getSize()I

    move-result v6

    invoke-virtual/range {v19 .. v19}, Lgov/nist/javax/sip/message/SIPResponse;->getContentLength()Ljavax/sip/header/ContentLengthHeader;
    ...
    .line 536
    .local v21, "sipServerResponse":Lgov/nist/javax/sip/stack/ServerResponseInterface;
    if-eqz v21, :cond_12
    ...
    .end local v21    # "sipServerResponse":Lgov/nist/javax/sip/stack/ServerResponseInterface;
    ...
    .line 548
    .restart local v21    # "sipServerResponse":Lgov/nist/javax/sip/stack/ServerResponseInterface;
    :cond_10
    :try_start_c
    move-object/from16 v0, v21
    ...
    .end local v19    # "sipResponse":Lgov/nist/javax/sip/message/SIPResponse;
    .end local v21    # "sipServerResponse":Lgov/nist/javax/sip/stack/ServerResponseInterface;
    .restart local v16    # "response":Lgov/nist/javax/sip/message/SIPResponse;
    .restart local v17    # "retryAfter":Lgov/nist/javax/sip/header/RetryAfter;
    .restart local v18    # "sipRequest":Lgov/nist/javax/sip/message/SIPRequest;
    .restart local v20    # "sipServerRequest":Lgov/nist/javax/sip/stack/ServerRequestInterface;
    :catch_2
    move-exception v5
