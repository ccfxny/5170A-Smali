.class public Lmeizu2_jcifs/http/Handler;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmeizu2_jcifs/http/Handler;->PROTOCOL_HANDLERS:Ljava/util/Map;
    ...
    sput-object v0, Lmeizu2_jcifs/http/Handler;->JVM_VENDOR_DEFAULT_PKGS:[Ljava/lang/String;
...
.method private static getDefaultStreamHandler(Ljava/lang/String;)Ljava/net/URLStreamHandler;
    ...
    .prologue
    .line 103
    sget-object v10, Lmeizu2_jcifs/http/Handler;->PROTOCOL_HANDLERS:Ljava/util/Map;

    monitor-enter v10

    .line 104
    :try_start_0
    sget-object v9, Lmeizu2_jcifs/http/Handler;->PROTOCOL_HANDLERS:Ljava/util/Map;
    ...
    :cond_0
    sget-object v9, Lmeizu2_jcifs/http/Handler;->factory:Ljava/net/URLStreamHandlerFactory;
    ...
    :goto_3
    :try_start_3
    sget-object v9, Lmeizu2_jcifs/http/Handler;->JVM_VENDOR_DEFAULT_PKGS:[Ljava/lang/String;
    ...
    sget-object v11, Lmeizu2_jcifs/http/Handler;->JVM_VENDOR_DEFAULT_PKGS:[Ljava/lang/String;
...
.method public static setURLStreamHandlerFactory(Ljava/net/URLStreamHandlerFactory;)V
    ...
    .prologue
    .line 75
    sget-object v1, Lmeizu2_jcifs/http/Handler;->PROTOCOL_HANDLERS:Ljava/util/Map;

    monitor-enter v1

    .line 76
    :try_start_0
    sget-object v0, Lmeizu2_jcifs/http/Handler;->factory:Ljava/net/URLStreamHandlerFactory;
    ...
    :cond_0
    :try_start_1
    sget-object v0, Lmeizu2_jcifs/http/Handler;->PROTOCOL_HANDLERS:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    .line 81
    sput-object p0, Lmeizu2_jcifs/http/Handler;->factory:Ljava/net/URLStreamHandlerFactory;
...
.method protected openConnection(Ljava/net/URL;)Ljava/net/URLConnection;
    ...
    invoke-static {v2}, Lmeizu2_jcifs/http/Handler;->getDefaultStreamHandler(Ljava/lang/String;)Ljava/net/URLStreamHandler;
    ...
    new-instance v2, Lmeizu2_jcifs/http/NtlmHttpURLConnection;
    ...
    invoke-direct {v2, v1}, Lmeizu2_jcifs/http/NtlmHttpURLConnection;-><init>(Ljava/net/HttpURLConnection;)V
