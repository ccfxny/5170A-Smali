.class interface abstract Lmeizu2_jcifs/smb/SmbConstants;
...
.field public static final NULL_TRANSPORT:Lmeizu2_jcifs/smb/SmbTransport;
...
.method static constructor <clinit>()V
    ...
    .line 20
    invoke-static {}, Lmeizu2_jcifs/Config;->getLocalHost()Ljava/net/InetAddress;

    move-result-object v0

    sput-object v0, Lmeizu2_jcifs/smb/SmbConstants;->LADDR:Ljava/net/InetAddress;

    .line 21
    const-string v0, "meizu2_jcifs.smb.client.lport"

    invoke-static {v0, v1}, Lmeizu2_jcifs/Config;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->LPORT:I

    .line 22
    const-string v0, "meizu2_jcifs.smb.client.maxMpxCount"

    const/16 v3, 0xa

    invoke-static {v0, v3}, Lmeizu2_jcifs/Config;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->MAX_MPX_COUNT:I

    .line 23
    const-string v0, "meizu2_jcifs.smb.client.snd_buf_size"
    ...
    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->SND_BUF_SIZE:I

    .line 24
    const-string v0, "meizu2_jcifs.smb.client.rcv_buf_size"
    ...
    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->RCV_BUF_SIZE:I

    .line 25
    const-string v0, "meizu2_jcifs.smb.client.useUnicode"

    invoke-static {v0, v8}, Lmeizu2_jcifs/Config;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_UNICODE:Z
    ...
    sput-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->FORCE_UNICODE:Z

    .line 27
    const-string v0, "meizu2_jcifs.smb.client.useNtStatus"

    invoke-static {v0, v8}, Lmeizu2_jcifs/Config;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_NTSTATUS:Z

    .line 28
    const-string v0, "meizu2_jcifs.smb.client.signingPreferred"

    invoke-static {v0, v1}, Lmeizu2_jcifs/Config;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->SIGNPREF:Z

    .line 29
    const-string v0, "meizu2_jcifs.smb.client.useNTSmbs"

    invoke-static {v0, v8}, Lmeizu2_jcifs/Config;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_NTSMBS:Z

    .line 30
    const-string v0, "meizu2_jcifs.smb.client.useExtendedSecurity"

    invoke-static {v0, v8}, Lmeizu2_jcifs/Config;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_EXTSEC:Z

    .line 32
    const-string v0, "meizu2_jcifs.netbios.hostname"

    invoke-static {v0, v9}, Lmeizu2_jcifs/Config;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lmeizu2_jcifs/smb/SmbConstants;->NETBIOS_HOSTNAME:Ljava/lang/String;
    ...
    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->LM_COMPATIBILITY:I
    ...
    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->PID:I
    ...
    sput-object v0, Lmeizu2_jcifs/smb/SmbConstants;->TZ:Ljava/util/TimeZone;

    .line 129
    const-string v0, "meizu2_jcifs.smb.client.useBatching"

    invoke-static {v0, v8}, Lmeizu2_jcifs/Config;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_BATCHING:Z

    .line 130
    const-string v0, "meizu2_jcifs.encoding"

    sget-object v3, Lmeizu2_jcifs/Config;->DEFAULT_OEM_ENCODING:Ljava/lang/String;

    invoke-static {v0, v3}, Lmeizu2_jcifs/Config;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lmeizu2_jcifs/smb/SmbConstants;->OEM_ENCODING:Ljava/lang/String;

    .line 132
    sget-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_EXTSEC:Z
    ...
    sget-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->SIGNPREF:Z
    ...
    sget-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_NTSTATUS:Z
    ...
    sget-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_UNICODE:Z
    ...
    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->DEFAULT_FLAGS2:I

    .line 139
    sget-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->USE_NTSMBS:Z
    ...
    :goto_4
    sget-boolean v3, Lmeizu2_jcifs/smb/SmbConstants;->USE_NTSTATUS:Z
    ...
    sget-boolean v3, Lmeizu2_jcifs/smb/SmbConstants;->USE_UNICODE:Z
    ...
    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->DEFAULT_CAPABILITIES:I

    .line 144
    const-string v0, "meizu2_jcifs.smb.client.flags2"

    sget v2, Lmeizu2_jcifs/smb/SmbConstants;->DEFAULT_FLAGS2:I

    invoke-static {v0, v2}, Lmeizu2_jcifs/Config;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->FLAGS2:I

    .line 145
    const-string v0, "meizu2_jcifs.smb.client.capabilities"

    sget v2, Lmeizu2_jcifs/smb/SmbConstants;->DEFAULT_CAPABILITIES:I

    invoke-static {v0, v2}, Lmeizu2_jcifs/Config;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->CAPABILITIES:I

    .line 146
    const-string v0, "meizu2_jcifs.smb.client.tcpNoDelay"

    invoke-static {v0, v1}, Lmeizu2_jcifs/Config;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lmeizu2_jcifs/smb/SmbConstants;->TCP_NODELAY:Z

    .line 147
    const-string v0, "meizu2_jcifs.smb.client.responseTimeout"
    ...
    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->RESPONSE_TIMEOUT:I
    ...
    sput-object v0, Lmeizu2_jcifs/smb/SmbConstants;->CONNECTIONS:Ljava/util/LinkedList;

    .line 152
    const-string v0, "meizu2_jcifs.smb.client.ssnLimit"
    ...
    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->SSN_LIMIT:I

    .line 154
    const-string v0, "meizu2_jcifs.smb.client.soTimeout"

    invoke-static {v0, v10}, Lmeizu2_jcifs/Config;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->SO_TIMEOUT:I

    .line 156
    const-string v0, "meizu2_jcifs.smb.client.connTimeout"

    invoke-static {v0, v10}, Lmeizu2_jcifs/Config;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Lmeizu2_jcifs/smb/SmbConstants;->CONN_TIMEOUT:I

    .line 158
    const-string v0, "meizu2_jcifs.smb.client.nativeOs"
    ...
    sput-object v0, Lmeizu2_jcifs/smb/SmbConstants;->NATIVE_OS:Ljava/lang/String;

    .line 160
    const-string v0, "meizu2_jcifs.smb.client.nativeLanMan"
    ...
    sput-object v0, Lmeizu2_jcifs/smb/SmbConstants;->NATIVE_LANMAN:Ljava/lang/String;

    .line 163
    new-instance v0, Lmeizu2_jcifs/smb/SmbTransport;

    invoke-direct {v0, v9, v1, v9, v1}, Lmeizu2_jcifs/smb/SmbTransport;-><init>(Lmeizu2_jcifs/UniAddress;ILjava/net/InetAddress;I)V

    sput-object v0, Lmeizu2_jcifs/smb/SmbConstants;->NULL_TRANSPORT:Lmeizu2_jcifs/smb/SmbTransport;
