.class public abstract Lmeizu2_jcifs/netbios/SessionServicePacket;
...
.method static readPacketType(Ljava/io/InputStream;[BI)I
    ...
    .line 84
    invoke-static {p0, p1, p2, v2}, Lmeizu2_jcifs/netbios/SessionServicePacket;->readn(Ljava/io/InputStream;[BII)I
...
.method readHeaderWireFormat(Ljava/io/InputStream;[BI)I
    ...
    .end local p3    # "bufferIndex":I
    .local v0, "bufferIndex":I
    aget-byte v1, p2, p3

    and-int/lit16 v1, v1, 0xff

    iput v1, p0, Lmeizu2_jcifs/netbios/SessionServicePacket;->type:I
    ...
    invoke-static {p2, v2}, Lmeizu2_jcifs/netbios/SessionServicePacket;->readInt2([BI)I

    move-result v2

    add-int/2addr v1, v2

    iput v1, p0, Lmeizu2_jcifs/netbios/SessionServicePacket;->length:I
...
.method readWireFormat(Ljava/io/InputStream;[BI)I
    ...
    .prologue
    .line 102
    invoke-virtual {p0, p1, p2, p3}, Lmeizu2_jcifs/netbios/SessionServicePacket;->readHeaderWireFormat(Ljava/io/InputStream;[BI)I

    .line 103
    invoke-virtual {p0, p1, p2, p3}, Lmeizu2_jcifs/netbios/SessionServicePacket;->readTrailerWireFormat(Ljava/io/InputStream;[BI)I
...
.method writeHeaderWireFormat([BI)I
    ...
    .end local p2    # "dstIndex":I
    .local v0, "dstIndex":I
    iget v1, p0, Lmeizu2_jcifs/netbios/SessionServicePacket;->type:I
    ...
    .line 107
    iget v1, p0, Lmeizu2_jcifs/netbios/SessionServicePacket;->length:I
    ...
    invoke-static {v1, p1, p2}, Lmeizu2_jcifs/netbios/SessionServicePacket;->writeInt2(I[BI)V
...
.method public writeWireFormat([BI)I
    ...
    invoke-virtual {p0, p1, v0}, Lmeizu2_jcifs/netbios/SessionServicePacket;->writeTrailerWireFormat([BI)I

    move-result v0

    iput v0, p0, Lmeizu2_jcifs/netbios/SessionServicePacket;->length:I

    .line 98
    invoke-virtual {p0, p1, p2}, Lmeizu2_jcifs/netbios/SessionServicePacket;->writeHeaderWireFormat([BI)I

    .line 99
    iget v0, p0, Lmeizu2_jcifs/netbios/SessionServicePacket;->length:I
