.class public Lmeizu2_jcifs/Config;
...
.method static constructor <clinit>()V
    ...
    sput v6, Lmeizu2_jcifs/Config;->socketCount:I
    ...
    sput-object v6, Lmeizu2_jcifs/Config;->prp:Ljava/util/Properties;

    .line 56
    const-string v6, "Cp850"

    sput-object v6, Lmeizu2_jcifs/Config;->DEFAULT_OEM_ENCODING:Ljava/lang/String;
    ...
    sput-object v6, Lmeizu2_jcifs/Config;->log:Lmeizu2_jcifs/util/LogStream;

    .line 66
    :try_start_0
    const-string v6, "meizu2_jcifs.properties"
    ...
    :cond_0
    invoke-static {v1}, Lmeizu2_jcifs/Config;->load(Ljava/io/InputStream;)V
    ...
    :cond_1
    :goto_0
    const-string v6, "meizu2_jcifs.util.loglevel"

    invoke-static {v6, v8}, Lmeizu2_jcifs/Config;->getInt(Ljava/lang/String;I)I
    ...
    sget-object v7, Lmeizu2_jcifs/Config;->DEFAULT_OEM_ENCODING:Ljava/lang/String;
    ...
    .line 92
    :goto_1
    sget-object v6, Lmeizu2_jcifs/Config;->log:Lmeizu2_jcifs/util/LogStream;
    ...
    .line 94
    :try_start_2
    sget-object v6, Lmeizu2_jcifs/Config;->prp:Ljava/util/Properties;

    sget-object v7, Lmeizu2_jcifs/Config;->log:Lmeizu2_jcifs/util/LogStream;
    ...
    sget-object v8, Lmeizu2_jcifs/Config;->DEFAULT_OEM_ENCODING:Ljava/lang/String;
...
.method public static get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .prologue
    .line 195
    sget-object v0, Lmeizu2_jcifs/Config;->prp:Ljava/util/Properties;
...
.method public static getBoolean(Ljava/lang/String;Z)Z
    ...
    .prologue
    .line 313
    invoke-static {p0}, Lmeizu2_jcifs/Config;->getProperty(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getInetAddress(Ljava/lang/String;Ljava/net/InetAddress;)Ljava/net/InetAddress;
    .locals 3
    .param p0, "key"    # Ljava/lang/String;
    .param p1, "def"    # Ljava/net/InetAddress;

    .prologue
    .line 278
    sget-object v2, Lmeizu2_jcifs/Config;->prp:Ljava/util/Properties;
    ...
    sget-object v2, Lmeizu2_jcifs/Config;->log:Lmeizu2_jcifs/util/LogStream;
    ...
    invoke-virtual {v2, v0}, Lmeizu2_jcifs/util/LogStream;->println(Ljava/lang/String;)V
...
.method public static getInetAddressArray(Ljava/lang/String;Ljava/lang/String;[Ljava/net/InetAddress;)[Ljava/net/InetAddress;
    ...
    .param p2, "def"    # [Ljava/net/InetAddress;
    ...
    invoke-virtual {v7, v0}, Lmeizu2_jcifs/util/LogStream;->println(Ljava/lang/String;)V
    ...
    .end local p2    # "def":[Ljava/net/InetAddress;
    :cond_0
    :goto_1
    return-object p2
    ...
    .restart local p2    # "def":[Ljava/net/InetAddress;
    :cond_1
    move-object p2, v1
...
.method public static getInt(Ljava/lang/String;)I
    ...
    .prologue
    .line 239
    sget-object v3, Lmeizu2_jcifs/Config;->prp:Ljava/util/Properties;
    ...
    sget-object v3, Lmeizu2_jcifs/Config;->log:Lmeizu2_jcifs/util/LogStream;
...
.method public static getLocalHost()Ljava/net/InetAddress;
    ...
    const-string v3, "meizu2_jcifs.smb.client.laddr"
    ...
    const-string v4, "Ignoring meizu2_jcifs.smb.client.laddr address: "
...
.method public static load(Ljava/io/InputStream;)V
    ...
    .line 160
    sget-object v1, Lmeizu2_jcifs/Config;->prp:Ljava/util/Properties;
    ...
    sget-object v1, Lmeizu2_jcifs/Config;->log:Lmeizu2_jcifs/util/LogStream;
...
.method public static setProperties(Ljava/util/Properties;)V
    .locals 3
    .param p0, "prp"    # Ljava/util/Properties;
    ...
    sput-object v1, Lmeizu2_jcifs/Config;->prp:Ljava/util/Properties;
