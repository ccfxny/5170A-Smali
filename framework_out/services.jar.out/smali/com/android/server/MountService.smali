...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2988
    .local v15, "otgFilter":Landroid/content/IntentFilter;
    ...
    .line 3013
    .local v16, "privacyProtectionFilter":Landroid/content/IntentFilter;
    ...
    .end local v15    # "otgFilter":Landroid/content/IntentFilter;
    .end local v16    # "privacyProtectionFilter":Landroid/content/IntentFilter;
    ...
    .restart local v15    # "otgFilter":Landroid/content/IntentFilter;
    ...
    .restart local v16    # "privacyProtectionFilter":Landroid/content/IntentFilter;
    .restart local v17    # "systemDir":Ljava/io/File;
    :catch_0
    move-exception v12
...
.method static synthetic access$4200(Lcom/android/server/MountService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Z
...
.method static synthetic access$4502(Lcom/android/server/MountService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Z
...
.method static synthetic access$4602(Lcom/android/server/MountService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Z
...
.method static synthetic access$4700(Lcom/android/server/MountService;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$4800(Lcom/android/server/MountService;)Landroid/os/storage/StorageVolume;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$4900(Lcom/android/server/MountService;)Ljava/util/concurrent/CountDownLatch;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$5000(Lcom/android/server/MountService;)Ljava/util/concurrent/CountDownLatch;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$5100(Lcom/android/server/MountService;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$5200(Lcom/android/server/MountService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$5300(Lcom/android/server/MountService;Ljava/lang/String;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$5400(Lcom/android/server/MountService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$5500(Lcom/android/server/MountService;)Lcom/android/internal/app/IMediaContainerService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$5502(Lcom/android/server/MountService;Lcom/android/internal/app/IMediaContainerService;)Lcom/android/internal/app/IMediaContainerService;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$5600(Lcom/android/server/MountService;)Ljava/util/Map;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$5700(Lcom/android/server/MountService;)Ljava/util/Map;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$5900(Lcom/android/server/MountService;)Lcom/android/server/MountService$DefaultContainerConnection;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$6000(Lcom/android/server/MountService;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$6100(Lcom/android/server/MountService;Ljava/lang/String;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
...
.method static synthetic access$6200(Lcom/android/server/MountService;Lcom/android/server/MountService$ObbState;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Lcom/android/server/MountService$ObbState;
...
.method static synthetic access$6300(Lcom/android/server/MountService;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$6400(Lcom/android/server/MountService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
    .param p1, "x1"    # Z
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    new-instance v8, Lcom/android/server/MountService$11;

    invoke-direct {v8, p0, v5, v6}, Lcom/android/server/MountService$11;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Landroid/os/storage/StorageVolume;)V

    invoke-virtual {v8}, Lcom/android/server/MountService$11;->start()V
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;IIZ)V
    ...
    .prologue
    .line 2280
    const-string v7, "/data/system/scsi"
    ...
    const-string v7, "ro.mtk_multi_patition"
    ...
    const-string v9, "notifyVolumeStateChange: volume had been deleted,just return!"
    ...
    const-string v9, "notifyVolumeStateChange::"
    ...
    const-string v8, "Sending ACTION_MEDIA_UNSHARED intent"
    ...
    invoke-direct {p0, v7, v6, v8}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    invoke-direct {p0, v0, v6, v7}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    const-string v8, "set prop sys.sd.unmounting = 0"

    invoke-static {v7, v8}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 2309
    const-string v7, "sys.sd.unmounting"
    ...
    const-string v9, "get state again, before get state="
    ...
    const-string v9, "get state again, after get state="
    ...
    const-string v8, "updating volume state for media bad removal nofs and unmountable"
    ...
    invoke-direct {p0, v6, v7, p1}, Lcom/android/server/MountService;->updatePublicVolumeState(Landroid/os/storage/StorageVolume;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v8, "IllegalArgumentException when set sys.sd.unmounting:"
    ...
    const-string v8, "updating volume state checking"
    ...
    const-string v8, "updating volume state mounted"
    ...
    const-string v8, "the filesystem of the mounted storage is FAT32. update maxFileSize to 4G"
    ...
    invoke-virtual {v6, v8, v9}, Landroid/os/storage/StorageVolume;->setMaxFileSize(J)V
    ...
    .line 2348
    iget-boolean v7, p0, Lcom/android/server/MountService;->mSetDefaultEnable:Z

    if-eqz v7, :cond_7

    iget-boolean v7, p0, Lcom/android/server/MountService;->mIsTurnOnOffUsb:Z

    if-nez v7, :cond_7

    iget-boolean v7, p0, Lcom/android/server/MountService;->mMountSwap:Z
    ...
    const-string v8, "updateDefaultpath VolumeState.Mounted"
    ...
    const-string v8, "the filesystem of the mounted storage is not FAT32. update maxFileSize to 0"
    ...
    const-string v8, "Updating volume state media mounted"
    ...
    const-string v8, "Updating media shared"
    ...
    const-string v8, "Sending ACTION_MEDIA_SHARED intent"
    ...
    const-string v8, "Live shared mounts not supported yet!"
    ...
    const-string v9, "Unhandled VolumeState {"
    ...
    const-string v9, "notifyVolumeStateChange->label = "
    ...
    .line 2383
    iget-object v7, p0, Lcom/android/server/MountService;->mDiskList:Ljava/util/ArrayList;
    ...
    .line 2384
    .local v3, "mTempInfo":Landroid/os/storage/DiskInfo;
    const/4 v7, 0x3

    if-ne p4, v7, :cond_e

    .line 2386
    iget-object v7, v3, Landroid/os/storage/DiskInfo;->mDiskName:Ljava/lang/String;

    const-string v8, "externalvolumechecking"

    invoke-direct {p0, v7, v8}, Lcom/android/server/MountService;->updateExternalVolumeState(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "action.external.volume.mounted"
    ...
    const-string v8, "externalvolumemounted"
    ...
    .end local v2    # "in":Landroid/content/Intent;
    const-string v7, "action.external.volume.unmounting"
    ...
    const-string v8, "externalvolumeunmounting"
    ...
    .end local v2    # "in":Landroid/content/Intent;
    const-string v7, "action.external.volume.idle"
    ...
    const-string v8, "externalvolumeidle"
...
.method public decryptStorage(Ljava/lang/String;)I
    ...
    new-instance v4, Lcom/android/server/MountService$18;

    invoke-direct {v4, p0}, Lcom/android/server/MountService$18;-><init>(Lcom/android/server/MountService;)V
...
.method public mountVolume(Ljava/lang/String;)I
    ...
    invoke-direct {v4, p0, v2}, Lcom/android/server/MountService$14;-><init>(Lcom/android/server/MountService;Landroid/os/storage/StorageVolume;)V
    ...
    invoke-virtual {v4}, Lcom/android/server/MountService$16;->start()V
...
.method public onDaemonConnected()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/MountService$9;-><init>(Lcom/android/server/MountService;Ljava/lang/String;)V
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string v5, "VoldResponseCode.ExternalVolumeDiskInserted"
    ...
    invoke-direct {v0, v4}, Lcom/android/server/MountService;->findDiskIndex(Ljava/lang/String;)I

    move-result v28

    .line 1815
    .local v28, "removeIndex":I
    const/4 v4, -0x1
    ...
    iget-object v4, v0, Lcom/android/server/MountService;->mDiskList:Ljava/util/ArrayList;
    ...
    new-instance v19, Landroid/os/storage/DiskInfo;
    ...
    invoke-direct {v0, v1, v4}, Landroid/os/storage/DiskInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 1820
    .local v19, "info":Landroid/os/storage/DiskInfo;
    const-string v4, "MountService"
    ...
    const-string v6, "prepare new mounted disk->name = "
    ...
    .line 1822
    const-string v4, "externalvolumeinserted"

    move-object/from16 v0, p0

    move-object/from16 v1, v25

    invoke-direct {v0, v1, v4}, Lcom/android/server/MountService;->updateExternalVolumeState(Ljava/lang/String;Ljava/lang/String;)V

    .line 2171
    .end local v18    # "index":I
    .end local v19    # "info":Landroid/os/storage/DiskInfo;
    .end local v25    # "name":Ljava/lang/String;
    .end local v28    # "removeIndex":I
    :cond_2
    :goto_1
    const/4 v4, 0x1
    ...
    const-string v5, "VoldResponseCode.ExternalVolumeDiskRemoved"
    ...
    .line 1828
    .restart local v28    # "removeIndex":I
    const/4 v4, -0x1
    ...
    .line 1830
    .restart local v19    # "info":Landroid/os/storage/DiskInfo;
    move-object/from16 v0, v19

    iget-object v4, v0, Landroid/os/storage/DiskInfo;->mDiskName:Ljava/lang/String;

    const-string v5, "externalvolumeremoved"

    move-object/from16 v0, p0

    invoke-direct {v0, v4, v5}, Lcom/android/server/MountService;->updateExternalVolumeState(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "action.external.volume.removed"
    ...
    invoke-direct {v0, v4, v5, v6, v7}, Lcom/android/server/MountService;->notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-virtual {v0, v6}, Landroid/os/storage/DiskInfo;->findPartition(Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v4}, Landroid/os/storage/DiskInfo;->findPartition(Ljava/lang/String;)I
    ...
    const-string v5, " info.add(cooked[3]);"
    ...
    invoke-virtual {v0, v4}, Landroid/os/storage/DiskInfo;->add(Ljava/lang/String;)V
    ...
    .line 1893
    .local v33, "uuid":Ljava/lang/String;
    :goto_3
    move-object/from16 v0, p0
    ...
    check-cast v34, Landroid/os/storage/StorageVolume;

    .line 1894
    .local v34, "vol":Landroid/os/storage/StorageVolume;
    if-eqz v34, :cond_2
    ...
    .line 1891
    .end local v33    # "uuid":Ljava/lang/String;
    .end local v34    # "vol":Landroid/os/storage/StorageVolume;
    :cond_d
    const/16 v33, 0x0
    ...
    .line 1902
    .local v32, "userLabel":Ljava/lang/String;
    :goto_4
    move-object/from16 v0, p0
    ...
    .line 1903
    .restart local v34    # "vol":Landroid/os/storage/StorageVolume;
    if-eqz v34, :cond_2
    ...
    .line 1900
    .end local v32    # "userLabel":Ljava/lang/String;
    .end local v34    # "vol":Landroid/os/storage/StorageVolume;
    :cond_f
    const/16 v32, 0x0
    ...
    check-cast v35, Landroid/os/storage/StorageVolume;

    .line 1931
    .local v35, "volume":Landroid/os/storage/StorageVolume;
    move-object/from16 v0, p0
    ...
    .end local v35    # "volume":Landroid/os/storage/StorageVolume;
    :catch_0
    move-exception v16
    ...
    .restart local v35    # "volume":Landroid/os/storage/StorageVolume;
    :cond_13
    const-string v4, "ro.mtk_2sdcard_swap"
    ...
    .line 1947
    .local v27, "primaryVolume":Landroid/os/storage/StorageVolume;
    monitor-exit v5
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
    ...
    .line 1953
    .end local v27    # "primaryVolume":Landroid/os/storage/StorageVolume;
    :cond_14
    ...
    invoke-direct {v4, v0, v5, v1}, Lcom/android/server/MountService$10;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v4}, Lcom/android/server/MountService$10;->start()V
    ...
    .line 2080
    .local v29, "secondaryVolume":Landroid/os/storage/StorageVolume;
    monitor-exit v5
    :try_end_5
    ...
    .line 2083
    .end local v29    # "secondaryVolume":Landroid/os/storage/StorageVolume;
    :cond_1c
    const-string v4, "MountService"
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/os/storage/StorageVolume;->toString()Ljava/lang/String;
...
.method public shareCDRom(Z)V
    ...
    .line 5274
    .local v0, "doShare":Z
    new-instance v1, Lcom/android/server/MountService$19;

    invoke-direct {v1, p0, v0}, Lcom/android/server/MountService$19;-><init>(Lcom/android/server/MountService;Z)V

    invoke-virtual {v1}, Lcom/android/server/MountService$19;->start()V
...
.method public shutdown(Landroid/os/storage/IMountShutdownObserver;)V
    ...
    .line 3187
    new-instance v11, Lcom/android/server/MountService$13;

    invoke-direct {v11, p0}, Lcom/android/server/MountService$13;-><init>(Lcom/android/server/MountService;)V

    invoke-virtual {v11}, Lcom/android/server/MountService$13;->start()V
...
.method public unmountVolumeForUserSwitch(Ljava/lang/String;ZZ)V
    ...
    invoke-direct {v1, p0, v7}, Lcom/android/server/MountService$17;-><init>(Lcom/android/server/MountService;Landroid/os/storage/StorageVolume;)V
