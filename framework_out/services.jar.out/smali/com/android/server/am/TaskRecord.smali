...
.field splitGroupId:I

.field splitLoc:I

.field splitMode:I

.field splitResumed:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/Intent;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;Landroid/content/ComponentName;ZZZIIILjava/lang/String;Ljava/util/ArrayList;JJJZLandroid/app/ActivityManager$TaskDescription;IIIIILjava/lang/String;)V
    ...
    iput v2, p0, Lcom/android/server/am/TaskRecord;->splitGroupId:I

    .line 1203
    const/4 v2, 0x0

    iput v2, p0, Lcom/android/server/am/TaskRecord;->splitMode:I

    .line 1204
    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/android/server/am/TaskRecord;->splitResumed:Z

    .line 1205
    const/4 v2, 0x0

    iput v2, p0, Lcom/android/server/am/TaskRecord;->splitLoc:I
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/app/ActivityManager$TaskDescription;)V
    ...
    .line 1203
    iput v3, p0, Lcom/android/server/am/TaskRecord;->splitMode:I

    .line 1204
    iput-boolean v3, p0, Lcom/android/server/am/TaskRecord;->splitResumed:Z

    .line 1205
    iput v3, p0, Lcom/android/server/am/TaskRecord;->splitLoc:I
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;)V
    ...
    .line 1202
    iput v3, p0, Lcom/android/server/am/TaskRecord;->splitGroupId:I
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    .line 1159
    iget v0, p0, Lcom/android/server/am/TaskRecord;->splitGroupId:I
    ...
    const-string v2, "splitGroupId="

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v2, p0, Lcom/android/server/am/TaskRecord;->splitGroupId:I
    ...
    const-string v2, "splitMode="

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v2, p0, Lcom/android/server/am/TaskRecord;->splitMode:I
    ...
    const-string v2, "splitResumed="

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v2, p0, Lcom/android/server/am/TaskRecord;->splitResumed:Z
...
.method public getHomeThumbnail()Landroid/app/ActivityManager$TaskThumbnail;
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/am/ActivityStack;->screenshotHomeActivities(Lcom/android/server/am/ActivityRecord;)Landroid/graphics/Bitmap;
...
.method public getTaskThumbnailLocked()Landroid/app/ActivityManager$TaskThumbnail;
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/am/ActivityStack;->screenshotActivities(Lcom/android/server/am/ActivityRecord;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    :goto_0
    new-instance v2, Landroid/app/ActivityManager$TaskThumbnail;

    invoke-direct {v2}, Landroid/app/ActivityManager$TaskThumbnail;-><init>()V

    .line 726
    .local v2, "taskThumbnail":Landroid/app/ActivityManager$TaskThumbnail;
    invoke-virtual {p0, v2}, Lcom/android/server/am/TaskRecord;->getLastThumbnail(Landroid/app/ActivityManager$TaskThumbnail;)V
    ...
    :cond_1
    iget-boolean v4, p0, Lcom/android/server/am/TaskRecord;->splitResumed:Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/am/TaskRecord;->topRunningActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/ActivityStack;->screenshotActivities(Lcom/android/server/am/ActivityRecord;)Landroid/graphics/Bitmap;
...
.method public hasRunableActivityLocked()Z
    .locals 3
