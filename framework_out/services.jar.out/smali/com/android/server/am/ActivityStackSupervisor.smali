...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/am/ActivityStackSupervisor$Injector;,
...
.field static final START_HOME_ACTIVITY:I = 0x74
...
.field mAcm:Lmeizu/security/AccessControlManager;
...
.method private scheduleStartHomeActivity(I)Z
    .locals 3
    .param p1, "mCurrentUser"    # I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/am/ActivityStackSupervisor$ActivityStackSupervisorHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method final activityIdleInternalLocked(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    const-string v4, "boostEnableTimeoutMs ready"
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    const-string v5, "ASS:realStartActivityLocked"
...
.method resumeHomeStackTask(ILcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z
    ...
    const-string v3, "schedule start Home activity for reason: "
    ...
    invoke-direct {p0, v1}, Lcom/android/server/am/ActivityStackSupervisor;->scheduleStartHomeActivity(I)Z
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IIILjava/lang/String;IIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    const-string v8, "ASS:startActivityLocked"

    invoke-static {v5, v8}, Landroid/debug/DebugUtils;->logAppLunch(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "com.tencent.mm/.plugin.luckymoney.ui.LuckyMoneyReceiveUI"
    ...
    invoke-virtual {v5, v8}, Landroid/os/PerfSchedulerManager;->boostBenchmark(I)V
    ...
    :cond_5
    const-string v5, "com.tencent.mm/.plugin.luckymoney.ui.LuckyMoneyDetailUI"
    ...
    .line 1427
    :cond_6
    const-string v5, "com.alipay.android.phone.discovery.envelope.get.SnsCouponDetailActivity"
    ...
    .line 1429
    :cond_7
    const-string v5, "com.alipay.android.phone.discovery.envelope.get.GetRedEnvelopeActivity"
    ...
    .line 1431
    :cond_8
    const-string v5, "com.tencent.mobileqq.activity.PayBridgeActivity"
    ...
    .line 1595
    .local v36, "watchIntent":Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 1602
    .end local v36    # "watchIntent":Landroid/content/Intent;
    :cond_1c
    :goto_c
    if-eqz v23, :cond_20
    ...
    .restart local v36    # "watchIntent":Landroid/content/Intent;
    :cond_1f
    const/4 v5, 0x0
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/android/server/am/ActivityStackSupervisor$Injector;->interceptForAccessControl(Lcom/android/server/am/ActivityStackSupervisor;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;I)Landroid/content/pm/ActivityInfo;
    ...
    const-string v5, "com.meizu.net.search"
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;ILandroid/app/IActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    const-string v4, "ASS:startActivityMayWait"
    ...
    invoke-static {v2, v0, v1, v4}, Lmeizu/security/FlymePermissionManager;->isGranted(ILjava/lang/String;II)Z
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;IZLandroid/os/Bundle;Lcom/android/server/am/TaskRecord;)I
    ...
    const-string v5, "ASS:startActivityUncheckedLocked"
    ...
    invoke-virtual {v4}, Landroid/content/Intent;->getSplitMode()Z
    ...
    iget-object v4, v4, Lcom/android/server/am/ActivityManagerService;->mSplitManager:Lcom/android/server/am/ActivitySplitModeManager;
    ...
    iget-object v4, v4, Lcom/android/server/am/ActivitySplitModeManager;->mLastRemoveTask:Lcom/android/server/am/TaskRecord;
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/am/ActivitySplitModeManager;->checkAndMoveSplitTask(Lcom/android/server/am/TaskRecord;)V
    ...
    .end local v18    # "isCalledFromSplit":Z
    ...
    .line 1777
    .restart local v18    # "isCalledFromSplit":Z
    ...
    :cond_29
    invoke-virtual/range {v16 .. v16}, Landroid/content/Intent;->getSplitMode()Z

    move-result v37

    .line 2008
    .local v37, "splitmode":Z
    if-eqz v37, :cond_2a
    ...
    invoke-virtual {v4, v5}, Landroid/content/Intent;->setSplitmode(Z)V
...
.method startSpecificActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    const-string v1, "ASS:startSpecificActivityLocked"
