...
.field private static final EVENT_HANDOFF_EXPIRED:I = 0x64
...
.field private static final HANDOFF_TRANSFER_TIME:I = 0xea60
...
.field private static sHandoffRadioType:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/ConnectivityService;->sHandoffRadioType:I
...
.method static synthetic access$4500(Lcom/android/server/ConnectivityService;)V
    ...
    .prologue
    .line 170
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->handleHandoffExpired()V
...
.method private assignNextNetId(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    const-string v5, "Reuse handoff networkId:"
    ...
    .line 849
    invoke-direct {p0, v6, v6}, Lcom/android/server/ConnectivityService;->notifyHandoverResult(ZZ)V
    ...
    .line 851
    sget-object v4, Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;->CONNECT:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;

    iput-object v4, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->handoffType:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;
...
.method private handleAsyncChannelDisconnected(Landroid/os/Message;)V
    ...
    .line 2261
    :try_start_0
    iget-object v10, v6, Lcom/android/server/connectivity/NetworkAgentInfo;->handoffType:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;

    sget-object v11, Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;->DISCONNECT:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;
...
.method private handleEpdgDisconnect(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    .line 4979
    iget-object v6, p0, Lcom/android/server/ConnectivityService;->mRnsManager:Lcom/mediatek/rns/RnsManager;
    ...
    check-cast v6, Lcom/mediatek/rns/RnsManager;

    iput-object v6, p0, Lcom/android/server/ConnectivityService;->mRnsManager:Lcom/mediatek/rns/RnsManager;
    ...
    const-string v7, "handleEpdgDisconnect:"
    ...
    invoke-virtual {v6, v3}, Lcom/mediatek/rns/RnsManager;->getTryAnotherRadioType(I)I

    move-result v5

    .line 5003
    .local v5, "tryNewRadio":I
    const/4 v1, 0x0
    ...
    .line 5006
    .local v2, "r":Landroid/net/NetworkRequest;
    ...
    .line 5012
    .end local v2    # "r":Landroid/net/NetworkRequest;
    :cond_2
    if-eqz v1, :cond_7
    ...
    const-string v7, "No retry for ePDG/Mobile and notify app:"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->handoffType:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;
    ...
    .line 5015
    iget-object v6, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->handoffType:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;

    sget-object v7, Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;->DISCONNECT:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;
    ...
    invoke-direct {p0, v3, v6}, Lcom/android/server/ConnectivityService;->updateFailureCause(ILandroid/net/NetworkCapabilities;)V
    ...
    .line 4996
    :cond_4
    const-string v6, "handleEpdgDisconnect done for default type"
    ...
    .restart local v2    # "r":Landroid/net/NetworkRequest;
    .restart local v5    # "tryNewRadio":I
    :cond_5
    add-int/lit8 v0, v0, 0x1
    ...
    .end local v2    # "r":Landroid/net/NetworkRequest;
    :cond_6
    const-string v6, "Handoff is running"
    ...
    sget-object v7, Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;->NONE:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;

    if-ne v6, v7, :cond_8

    .line 5023
    invoke-direct {p0, v5}, Lcom/android/server/ConnectivityService;->handleNetworkSelection(I)I
    ...
    invoke-direct {p0, v6, v4}, Lcom/android/server/ConnectivityService;->retryRequestToNetwork(Landroid/util/SparseArray;I)V
    ...
    .line 5028
    const-string v6, "Disconnected by handoff"
    ...
    sget-object v7, Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;->CONNECT:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;

    if-ne v6, v7, :cond_a

    .line 5030
    const-string v6, "Failed to setup new RAT on handover"

    invoke-static {v6}, Lcom/android/server/ConnectivityService;->log(Ljava/lang/String;)V

    .line 5031
    sget v6, Lcom/android/server/ConnectivityService;->sHandoffRadioType:I

    invoke-direct {p0, v6, v8, v8}, Lcom/android/server/ConnectivityService;->sendHandoverIntent(IZZ)V

    .line 5032
    sput v10, Lcom/android/server/ConnectivityService;->sHandoffRadioType:I
...
.method private handleHandoffExpired()V
    .locals 3
    ...
    .line 5113
    sget v0, Lcom/android/server/ConnectivityService;->sHandoffRadioType:I
    ...
    const-string v1, "Handoff prcoedurer taks too long"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 5115
    sput v2, Lcom/android/server/ConnectivityService;->sHandoffRadioType:I
...
.method private handleRegisterNetworkRequest(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v6}, Lcom/android/server/ConnectivityService;->isHandoffSupport(Landroid/net/NetworkCapabilities;)Z
...
.method private handleRnsSelection(I)I
    ...
    .line 5064
    const-string v1, "Rns allow to create WiFi"
    ...
    .line 5068
    const-string v1, "Rns allow to create Mobile"
...
.method private isHandoffSupport(Landroid/net/NetworkCapabilities;)Z
    .locals 2
...
.method private retryRequestToNetwork(Landroid/util/SparseArray;I)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/ConnectivityService;->isHandoffSupport(Landroid/net/NetworkCapabilities;)Z
...
.method private updateFailureCause(ILandroid/net/NetworkCapabilities;)V
    ...
    .line 5181
    invoke-virtual {p0, p1}, Lcom/android/server/ConnectivityService;->getNetworkInfo(I)Landroid/net/NetworkInfo;
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    invoke-direct {p0, p1, v6, v7}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$NascentState;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;)V
    ...
    const-string v7, "Handoff connection is connected:"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget v7, Lcom/android/server/ConnectivityService;->sHandoffRadioType:I
    ...
    invoke-direct {p0, v6, v7}, Lcom/android/server/ConnectivityService;->setNetworkFactoryScore(Ljava/lang/String;I)V
    ...
    .line 4605
    sget-object v6, Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;->DISCONNECT:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;

    iput-object v6, v4, Lcom/android/server/connectivity/NetworkAgentInfo;->handoffType:Lcom/android/server/connectivity/NetworkAgentInfo$HandoffType;
    ...
    const-string v7, "get current score"
    ...
    invoke-direct {p0, v6, v7}, Lcom/android/server/ConnectivityService;->notifyHandoverResult(ZZ)V
    :try_end_4
    ...
    invoke-interface {v6, v7}, Landroid/os/INetworkManagementService;->createPhysicalNetwork(I)V
    :try_end_5
...
.method public addToNotShowVpnIcon(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/connectivity/Vpn;->addToNotShowVpnIconList(Ljava/lang/String;)Z
...
.method public connectToRadio(I)V
    ...
    const-string v9, "Wrong radioTye:"
    ...
    const-string v8, "Handover is ongoing:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    sget v8, Lcom/android/server/ConnectivityService;->sHandoffRadioType:I
    ...
    const-string v9, "connectToRadio nwTypeName = "
    ...
    invoke-virtual {v7, v8, v3, v9, v5}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
    ...
    const-string v8, "Start handover"

    invoke-static {v7, v8}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 4950
    sput p1, Lcom/android/server/ConnectivityService;->sHandoffRadioType:I
    ...
    invoke-virtual {v7, v8, v10, v11}, Lcom/android/server/ConnectivityService$InternalHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
