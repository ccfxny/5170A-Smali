...
.field public static final CHINESE_LOCATION_PACKAGENAME:Ljava/lang/String; = "com.amap.android.location"
...
.field mFreezeBlackList:Landroid/os/freeze/FlymeFreezeList;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 244
    iput-boolean v1, p0, Lcom/android/server/LocationManagerService;->mProviderCheckAlarm:Z

    .line 278
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mFreezeBlackList:Landroid/os/freeze/FlymeFreezeList;

    .line 2620
    new-instance v0, Lcom/android/server/LocationManagerService$6;

    invoke-direct {v0, p0}, Lcom/android/server/LocationManagerService$6;-><init>(Lcom/android/server/LocationManagerService;)V
    ...
    .line 287
    new-instance v0, Landroid/os/freeze/FlymeFreezeList;

    invoke-direct {v0, p1}, Landroid/os/freeze/FlymeFreezeList;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mFreezeBlackList:Landroid/os/freeze/FlymeFreezeList;

    .line 288
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mFreezeBlackList:Landroid/os/freeze/FlymeFreezeList;

    invoke-virtual {v0}, Landroid/os/freeze/FlymeFreezeList;->freezeRegisterListener()V
...
.method static synthetic access$1400(Lcom/android/server/LocationManagerService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1600(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$LocationWorkerHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1700(Lcom/android/server/LocationManagerService;I)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # I
...
.method static synthetic access$1800(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$Receiver;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/os/freeze/FlymeFreezeList;->isFreeze(I)Z
    ...
    const-string v33, "skipping loc update for freezeBlacklisted app uid: "
...
.method private initSettingProvider()V
    ...
    new-instance v1, Lcom/android/server/LocationManagerService$NetworkStateReceiver;

    invoke-direct {v1, p0, v4}, Lcom/android/server/LocationManagerService$NetworkStateReceiver;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V
    ...
    const-string v2, "load the default mode="
    ...
    const-string v1, "load default network provider"
    ...
    const-string v2, "load the default network provider name="
    ...
    .line 3148
    :cond_3
    new-instance v0, Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;

    iget-object v1, p0, Lcom/android/server/LocationManagerService;->mLocationHandler:Lcom/android/server/LocationManagerService$LocationWorkerHandler;

    iget-object v2, p0, Lcom/android/server/LocationManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v1, v2}, Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;-><init>(Lcom/android/server/LocationManagerService;Landroid/os/Handler;Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mModeObserver:Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;

    .line 3149
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mModeObserver:Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;

    invoke-virtual {v0}, Lcom/android/server/LocationManagerService$NetWorkProviderModeSettingsObserver;->observer()V
    ...
    .line 3127
    :cond_4
    const-string v6, "com.amap.android.location"
    ...
    const-string v1, "load baidu network provider"
    ...
    const-string v1, "load google network provider"
...
.method private locationIPOcreateProvider()V
    ...
    invoke-static {v0, v1, v2, v5, v3}, Lcom/android/server/location/GeocoderProxy;->createAndBind(Landroid/content/Context;IIILandroid/os/Handler;)Lcom/android/server/location/GeocoderProxy;
...
.method private mayChangeSettingProvider(Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/location/GeocoderProxy;->unbind()V
    ...
    invoke-static {v2, v6, v5, v3, v4}, Lcom/android/server/location/GeocoderProxy;->createAndBind(Landroid/content/Context;IIILandroid/os/Handler;)Lcom/android/server/location/GeocoderProxy;
...
.method private removeProviderCheck()V
    ...
    const-string v2, "removeProviderCheck : "
...
.method private triggerProviderCheck()V
    ...
    const-string v2, "triggerProviderCheck before: "
    ...
    iget-object v4, p0, Lcom/android/server/LocationManagerService;->mProviderCheckTimeoutIntent:Landroid/app/PendingIntent;
...
.method private updateProviderListenersLocked(Ljava/lang/String;Z)V
    ...
    .line 1557
    iget-object v7, p0, Lcom/android/server/LocationManagerService;->mFreezeBlackList:Landroid/os/freeze/FlymeFreezeList;
    ...
    invoke-virtual {v7, v8}, Landroid/os/freeze/FlymeFreezeList;->isFreeze(I)Z
    ...
    const-string v9, "skipping loc provider update for freezeBlacklisted app uid: "
...
.method public doTelephonyServiceStateChanged(Landroid/content/Intent;)V
    ...
    const-string v5, "doTelephonyServiceStateChanged intent="
    ...
    const-string v5, " operatornumber="
...
.method public findNetworkProviderWhenAutoMode()V
    ...
    const-string v5, "findNetworkProviderWhenAutoMode camped mcc="
    ...
    const-string v5, "findNetworkProviderWhenAutoMode sim mcc="
...
.method public getLastLocation(Landroid/location/LocationRequest;Ljava/lang/String;)Landroid/location/Location;
    ...
    .line 1985
    const-string v9, "sub-permission.ACCESS_LOCATION"
    ...
    const-string v11, "moms denied getLastLocation pkg:"
...
.method public locationCallbackFinished(Landroid/location/ILocationListener;)V
    ...
    invoke-static {v1}, Lcom/android/server/LocationManagerService$Receiver;->access$1900(Lcom/android/server/LocationManagerService$Receiver;)V
...
.method public requestGeofence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    const-string v3, "moms denied requestGeofence pkg:"
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    const-string v7, "moms denied requestLocationUpdates pkg:"
...
.method public systemRunning()V
    ...
    .line 316
    new-instance v9, Lcom/android/server/LocationManagerService$1;

    invoke-direct {v9, p0}, Lcom/android/server/LocationManagerService$1;-><init>(Lcom/android/server/LocationManagerService;)V

    .line 327
    .local v9, "callback":Landroid/app/AppOpsManager$OnOpChangedListener;
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mAppOps:Landroid/app/AppOpsManager;
    ...
    invoke-virtual {v0, v2, v5, v9}, Landroid/app/AppOpsManager;->startWatchingMode(ILjava/lang/String;Landroid/app/AppOpsManager$OnOpChangedListener;)V
    ...
    .line 376
    .local v10, "intentIPOFilter":Landroid/content/IntentFilter;
    ...
    .line 395
    :cond_0
    const-string v8, "com.mediatek.location.providercheck"
    ...
    .line 397
    .local v11, "intentPvdChkFilter":Landroid/content/IntentFilter;
    const-string v0, "com.mediatek.location.providercheck"
    ...
    const-string v2, "com.mediatek.location.providercheck"
    ...
    .end local v9    # "callback":Landroid/app/AppOpsManager$OnOpChangedListener;
    .end local v10    # "intentIPOFilter":Landroid/content/IntentFilter;
    .end local v11    # "intentPvdChkFilter":Landroid/content/IntentFilter;
    :catchall_0
    move-exception v0
