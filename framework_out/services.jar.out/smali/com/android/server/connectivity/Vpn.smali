...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/IConnectivityManager;I)V
    ...
    iput-object v0, p0, Lcom/android/server/connectivity/Vpn;->mBlackListShowNotify:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v7}, Landroid/net/NetworkCapabilities;->removeCapability(I)Landroid/net/NetworkCapabilities;
...
.method static synthetic access$2100(Lcom/android/server/connectivity/Vpn;Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
    .param p1, "x1"    # Landroid/net/NetworkInfo$DetailedState;
    .param p2, "x2"    # Ljava/lang/String;
    ...
    .prologue
    .line 126
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/connectivity/Vpn;->updateState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Z)V

    return-void
.end method

.method static synthetic access$2200(Lcom/android/server/connectivity/Vpn;)Landroid/net/NetworkInfo;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
...
.method static synthetic access$2300(Lcom/android/server/connectivity/Vpn;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
...
.method static synthetic access$2400(Lcom/android/server/connectivity/Vpn;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
...
.method static synthetic access$2500(Lcom/android/server/connectivity/Vpn;)Lcom/android/internal/net/LegacyVpnInfo;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
...
.method static synthetic access$2502(Lcom/android/server/connectivity/Vpn;Lcom/android/internal/net/LegacyVpnInfo;)Lcom/android/internal/net/LegacyVpnInfo;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
...
.method static synthetic access$2600(Lcom/android/server/connectivity/Vpn;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
    .param p1, "x1"    # I
...
.method static synthetic access$2700(Lcom/android/server/connectivity/Vpn;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
...
.method static synthetic access$900(Lcom/android/server/connectivity/Vpn;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/Vpn;
    .param p1, "x1"    # Ljava/lang/String;
...
.method private addVpnUserLocked(I)V
    ...
    const-string v22, "VPN is not active"
    ...
    invoke-interface/range {v21 .. v21}, Ljava/util/SortedSet;->iterator()Ljava/util/Iterator;
    ...
    new-instance v22, Landroid/net/UidRange;

    move-object/from16 v0, v22

    invoke-direct {v0, v14, v15}, Landroid/net/UidRange;-><init>(II)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/connectivity/Vpn;->isPackageInVpnBlackList(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v11, v5, v1, v2}, Lcom/android/server/connectivity/Vpn;->showNotification(Ljava/lang/String;Landroid/graphics/Bitmap;ILjava/lang/String;)V
    :try_end_2
    ...
    .line 722
    .local v19, "userRange":Landroid/net/UidRange;
    move-object/from16 v0, v19

    iget v14, v0, Landroid/net/UidRange;->start:I
    ...
    invoke-direct {v0, v14, v1}, Landroid/net/UidRange;-><init>(II)V
    ...
    .end local v9    # "i$":Ljava/util/Iterator;
    .end local v14    # "start":I
    .end local v19    # "userRange":Landroid/net/UidRange;
    :cond_a
    move-object/from16 v0, p0
    ...
    const-string v22, "Invalid application"
...
.method private agentDisconnect()V
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/android/server/connectivity/Vpn;->updateState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Z)V
...
.method private flymeInterfaceRemoved(Ljava/lang/String;)V
    ...
    const-string v5, "There isn\'t any activeNetwork, set it to wait for reconnect status"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1978
    new-instance v4, Lcom/android/internal/net/LegacyVpnInfo;

    invoke-direct {v4}, Lcom/android/internal/net/LegacyVpnInfo;-><init>()V

    iput-object v4, p0, Lcom/android/server/connectivity/Vpn;->mWaitingForReconnectInfo:Lcom/android/internal/net/LegacyVpnInfo;

    .line 1979
    iget-object v4, p0, Lcom/android/server/connectivity/Vpn;->mWaitingForReconnectInfo:Lcom/android/internal/net/LegacyVpnInfo;

    iget-object v5, p0, Lcom/android/server/connectivity/Vpn;->mCurrentConfig:Lcom/android/internal/net/VpnConfig;

    iget-object v5, v5, Lcom/android/internal/net/VpnConfig;->user:Ljava/lang/String;

    iput-object v5, v4, Lcom/android/internal/net/LegacyVpnInfo;->key:Ljava/lang/String;

    .line 1980
    iget-object v4, p0, Lcom/android/server/connectivity/Vpn;->mWaitingForReconnectInfo:Lcom/android/internal/net/LegacyVpnInfo;

    iput v8, v4, Lcom/android/internal/net/LegacyVpnInfo;->state:I

    .line 1982
    iget-object v4, p0, Lcom/android/server/connectivity/Vpn;->mReconnectHandler:Landroid/os/Handler;
    ...
    .line 1983
    invoke-direct {p0, v8}, Lcom/android/server/connectivity/Vpn;->sendVpnStateChangeBroadcast(I)V
...
.method private flymeUpdateStateForFailedDetail()V
    ...
    .prologue
    .line 1655
    const-string v1, "meizu.vpn.mtpd.exit_status"
    ...
    const-string v3, "mtpd_exit_status is "
    ...
    invoke-direct {p0, v1, v2, v3}, Lcom/android/server/connectivity/Vpn;->updateStateForFailedDetail(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/connectivity/Vpn;->updateState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;)V
...
.method private getDefaultNetwork()[Ljava/lang/String;
    ...
    .line 1667
    iget-object v7, p0, Lcom/android/server/connectivity/Vpn;->mConnService:Landroid/net/IConnectivityManager;
    ...
    invoke-interface {v7}, Landroid/net/IConnectivityManager;->getActiveLinkProperties()Landroid/net/LinkProperties;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v8, "no active link"
...
.method private hideNotification(I)V
    ...
    const-string v2, "hide notification"
...
.method private initFlymeChange()V
    ...
    .line 1873
    iput v2, p0, Lcom/android/server/connectivity/Vpn;->mFailedDetail:I
    ...
    .line 1877
    iput v2, p0, Lcom/android/server/connectivity/Vpn;->mWifiGatewayPrifexLength:I

    .line 1878
    new-instance v1, Lcom/android/server/connectivity/Vpn$4;

    invoke-direct {v1, p0}, Lcom/android/server/connectivity/Vpn$4;-><init>(Lcom/android/server/connectivity/Vpn;)V
    ...
    iput-object v1, p0, Lcom/android/server/connectivity/Vpn;->mConnectivityChangeReceiver:Landroid/content/BroadcastReceiver;
...
.method private isPackageInVpnBlackList(Ljava/lang/String;)Z
    ...
    .line 2054
    iget-object v4, p0, Lcom/android/server/connectivity/Vpn;->mBlackListShowNotify:Ljava/util/ArrayList;
    ...
    const-string v4, "mBlackListShowNotify is null or mBlackListShowNotify size is null"
    ...
    const-string v5, " is not in mBlackListShowNotify"
...
.method private removeFlymeReconnectInfo()V
    ...
    const-string v1, "removeMessages MSG_RECONNECT"
...
.method private sendVpnStateChangeBroadcast(I)V
    ...
    const-string v3, "sendVpnStateChangeBroadcast "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, "vpnState:%d"
...
.method private showNotification(Ljava/lang/String;Landroid/graphics/Bitmap;ILjava/lang/String;)V
    ...
    iget-object v7, v0, Lcom/android/server/connectivity/Vpn;->mContext:Landroid/content/Context;
    ...
    iput-object v7, v0, Lcom/android/server/connectivity/Vpn;->mStatusIntent:Landroid/app/PendingIntent;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v10, v0, Lcom/android/server/connectivity/Vpn;->mContext:Landroid/content/Context;
    ...
    iget-object v10, v0, Lcom/android/server/connectivity/Vpn;->mStatusIntent:Landroid/app/PendingIntent;
    ...
    invoke-virtual {v7, v10}, Landroid/app/Notification$Builder;->setDefaults(I)Landroid/app/Notification$Builder;
    ...
    iget-object v7, v2, Landroid/app/Notification$Builder;->mFlymeNotificationBuilder:Landroid/app/NotificationBuilderExt;

    const v10, 0xa02033f

    invoke-virtual {v7, v10}, Landroid/app/NotificationBuilderExt;->setNotificationIcon(I)V
    ...
    invoke-virtual {v3, v0, v7, v4, v10}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    iget-object v14, v14, Lcom/android/internal/net/VpnConfig;->session:Ljava/lang/String;
...
.method public addToNotShowVpnIconList(Ljava/lang/String;)Z
    ...
    const-string v3, " is already in mBlackListShowNotify"
