...
.field private static final CMD_USER_LOGIN_TIMEOUT:I = 0x8201e
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkRequest;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/connectivity/NetworkMonitor;->mSkipNetworkValidation:Z
...
.method static synthetic access$4100(Lcom/android/server/connectivity/NetworkMonitor;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/NetworkMonitor;
...
.method static synthetic access$4102(Lcom/android/server/connectivity/NetworkMonitor;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/connectivity/NetworkMonitor;
    .param p1, "x1"    # I
...
.method static synthetic access$4300(Lcom/android/server/connectivity/NetworkMonitor;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/NetworkMonitor;
...
.method private isCaptivePortal()I
    ...
    .line 817
    :cond_6
    invoke-direct {p0}, Lcom/android/server/connectivity/NetworkMonitor;->isDefaultDnsReachable()Z
    ...
    .line 818
    const-string v3, "Default dnses are reachable"
...
.method private isDefaultDnsReachable()Z
    .locals 7
    ...
    :try_start_0
    const-string v6, "/system/bin/ping -c 1 -w 10 8.8.8.8"
    ...
    .line 837
    .local v1, "ping":Ljava/lang/Process;
    ...
    .local v2, "ret":Z
    :goto_0
    const-string v6, "/system/bin/ping -c 1 -w 10 223.6.6.6"
    ...
    .line 840
    const-string v6, "/system/bin/ping -c 1 -w 10 114.114.114.114"
    ...
    .line 845
    .end local v1    # "ping":Ljava/lang/Process;
    .end local v2    # "ret":Z
    :goto_3
    return v2

    .restart local v1    # "ping":Ljava/lang/Process;
    :cond_0
    move v2, v5
    ...
    const-string v6, "isDefaultDnsReachable error: "
