...
.method public crash(Ljava/lang/String;)V
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mContext:Landroid/content/Context;
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$200(Lcom/android/server/power/PowerManagerService;)Landroid/content/Context;
...
.method public getWakeLockData()Ljava/util/List;
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->getWakeLockDataInternal()Ljava/util/List;
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$5300(Lcom/android/server/power/PowerManagerService;)Ljava/util/List;
...
.method public isScreenDim()Z
    ...
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$7500(Lcom/android/server/power/PowerManagerService;)I
...
.method public reboot(ZLjava/lang/String;Z)V
    ...
    invoke-static {v2, v3, p1, p2, p3}, Lcom/android/server/power/PowerManagerService;->access$6200(Lcom/android/server/power/PowerManagerService;ZZLjava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public registerCallback(Landroid/os/IPowerManagerWakeupOrSleepReasonCallback;Ljava/lang/String;)V
    .locals 8
    .param p1, "callback"    # Landroid/os/IPowerManagerWakeupOrSleepReasonCallback;
    ...
    invoke-static {v4}, Lcom/android/server/power/PowerManagerService;->access$7600(Lcom/android/server/power/PowerManagerService;)Ljava/util/ArrayList;
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->findByTag(Ljava/lang/String;)Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;
    invoke-static {v4, p2}, Lcom/android/server/power/PowerManagerService;->access$7700(Lcom/android/server/power/PowerManagerService;Ljava/lang/String;)Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;

    move-result-object v2

    .line 4251
    .local v2, "find":Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;
    if-nez v2, :cond_2

    .line 4252
    new-instance v3, Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;

    iget-object v4, p0, Lcom/android/server/power/PowerManagerService$BinderService;->this$0:Lcom/android/server/power/PowerManagerService;

    invoke-direct {v3, v4, p1, p2}, Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;-><init>(Lcom/android/server/power/PowerManagerService;Landroid/os/IPowerManagerWakeupOrSleepReasonCallback;Ljava/lang/String;)V

    .line 4253
    .local v3, "listener":Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;
    new-instance v0, Lcom/android/server/power/PowerManagerService$WakeupOrSleepReasonBinderDeath;
    ...
    invoke-direct {v0, v4, p2, v6, v3}, Lcom/android/server/power/PowerManagerService$WakeupOrSleepReasonBinderDeath;-><init>(Lcom/android/server/power/PowerManagerService;Ljava/lang/String;ILcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;)V

    .line 4254
    .local v0, "binderDeath":Lcom/android/server/power/PowerManagerService$WakeupOrSleepReasonBinderDeath;
    invoke-interface {p1}, Landroid/os/IPowerManagerWakeupOrSleepReasonCallback;->asBinder()Landroid/os/IBinder;
    ...
    const-string v7, "registerCallback "
    ...
    .line 4261
    .end local v0    # "binderDeath":Lcom/android/server/power/PowerManagerService$WakeupOrSleepReasonBinderDeath;
    .end local v2    # "find":Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;
    .end local v3    # "listener":Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;
    :cond_2
    :goto_1
    :try_start_1
    monitor-exit v5
...
.method public setBacklightOffForWfd(Z)V
    ...
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$7200(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/lights/Light;
...
.method public setBlNotify()V
    ...
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$7100(Z)V
...
.method public startBacklight(I)V
    ...
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$1500(Lcom/android/server/power/PowerManagerService;)Landroid/hardware/display/DisplayManagerInternal;
    ...
    invoke-static {v2, v4, v5, v6}, Lcom/android/server/power/PowerManagerService;->access$1400(Lcom/android/server/power/PowerManagerService;JI)Z

    .line 4180
    iget-object v2, p0, Lcom/android/server/power/PowerManagerService$BinderService;->this$0:Lcom/android/server/power/PowerManagerService;

    # invokes: Lcom/android/server/power/PowerManagerService;->updatePowerStateLocked()V
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$1800(Lcom/android/server/power/PowerManagerService;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public stopBacklight()V
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mDisplayManagerInternal:Landroid/hardware/display/DisplayManagerInternal;
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$1500(Lcom/android/server/power/PowerManagerService;)Landroid/hardware/display/DisplayManagerInternal;
...
.method public unregisterCallback(Landroid/os/IPowerManagerWakeupOrSleepReasonCallback;Ljava/lang/String;)V
    .locals 5
    .param p1, "callback"    # Landroid/os/IPowerManagerWakeupOrSleepReasonCallback;
    .param p2, "tag"    # Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mWakeupOrSleepListeners:Ljava/util/ArrayList;
    invoke-static {v1}, Lcom/android/server/power/PowerManagerService;->access$7600(Lcom/android/server/power/PowerManagerService;)Ljava/util/ArrayList;
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->findByTag(Ljava/lang/String;)Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;
    invoke-static {v1, p2}, Lcom/android/server/power/PowerManagerService;->access$7700(Lcom/android/server/power/PowerManagerService;Ljava/lang/String;)Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;

    move-result-object v0

    .line 4268
    .local v0, "find":Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;
    if-eqz v0, :cond_0
    ...
    iget-object v4, v0, Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;->mTag:Ljava/lang/String;
    ...
    .line 4272
    .end local v0    # "find":Lcom/android/server/power/PowerManagerService$PowerManagerWakeupOrSleepReasonListener;
    :catchall_0
    move-exception v1
...
.method public userActivity(JII)V
    ...
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$5400(Lcom/android/server/power/PowerManagerService;)J
    ...
    invoke-static {v0, v10, v11}, Lcom/android/server/power/PowerManagerService;->access$5402(Lcom/android/server/power/PowerManagerService;J)J
    ...
    invoke-static/range {v1 .. v6}, Lcom/android/server/power/PowerManagerService;->access$5500(Lcom/android/server/power/PowerManagerService;JIII)V
    :try_end_1
...
.method public wakeUpByReason(JI)I
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->wakeUpByReasonInternalUid(JII)I
    invoke-static {v3, p1, p2, v2, p3}, Lcom/android/server/power/PowerManagerService;->access$7000(Lcom/android/server/power/PowerManagerService;JII)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v3, p1, p2, p3}, Lcom/android/server/power/PowerManagerService;->access$1300(Lcom/android/server/power/PowerManagerService;JI)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
