...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;
    ...
    .line 3791
    iput-boolean v3, p0, Lcom/android/server/notification/NotificationManagerService;->mProximitySensorEnabled:Z
...
.method static synthetic access$3400(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/NotificationRecord;ZI)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
    .param p1, "x1"    # Lcom/android/server/notification/NotificationRecord;
    .param p2, "x2"    # Z
...
.method static synthetic access$3700(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/NotificationRecord;Lcom/android/server/notification/NotificationRecord;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
    .param p1, "x1"    # Lcom/android/server/notification/NotificationRecord;
...
.method static synthetic access$3800(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/NotificationRecord;Lcom/android/server/notification/NotificationRecord;II)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
    .param p1, "x1"    # Lcom/android/server/notification/NotificationRecord;
    .param p2, "x2"    # Lcom/android/server/notification/NotificationRecord;
...
.method static synthetic access$3900(Lcom/android/server/notification/NotificationManagerService;Ljava/lang/String;ILandroid/app/Notification;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
...
.method static synthetic access$5900(Lcom/android/server/notification/NotificationManagerService;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
...
.method static synthetic access$6000(Lcom/android/server/notification/NotificationManagerService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$6100(Lcom/android/server/notification/NotificationManagerService;)Z
    ...
    .prologue
    .line 162
    iget-boolean v0, p0, Lcom/android/server/notification/NotificationManagerService;->mIsLidOpened:Z
...
.method static synthetic access$6102(Lcom/android/server/notification/NotificationManagerService;Z)Z
    ...
    .prologue
    .line 162
    iput-boolean p1, p0, Lcom/android/server/notification/NotificationManagerService;->mIsLidOpened:Z
...
.method static synthetic access$6300(Lcom/android/server/notification/NotificationManagerService;)Landroid/hardware/Sensor;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
...
.method static synthetic access$6400(Lcom/android/server/notification/NotificationManagerService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
    .param p1, "x1"    # Z
...
.method private buzzBeepBlinkLocked(Lcom/android/server/notification/NotificationRecord;)V
    ...
    iget-boolean v5, v0, Lcom/android/server/notification/NotificationManagerService;->mScreenOn:Z

    move-object/from16 v0, p0

    iget-boolean v6, v0, Lcom/android/server/notification/NotificationManagerService;->mInCall:Z

    move-object/from16 v0, p1

    move-object/from16 v1, p0

    invoke-static {v0, v4, v5, v6, v1}, Lcom/android/server/notification/NotificationManagerService$NMSInjector;->NotiWakeupScreen(Lcom/android/server/notification/NotificationRecord;Landroid/content/Context;ZZLcom/android/server/notification/NotificationManagerService;)V
...
.method private disableProximityLockLocked()V
    ...
    .prologue
    .line 3846
    iget-boolean v2, p0, Lcom/android/server/notification/NotificationManagerService;->mProximitySensorEnabled:Z
    ...
    .local v0, "identity":J
    :try_start_0
    iget-object v2, p0, Lcom/android/server/notification/NotificationManagerService;->mSensorManager:Landroid/hardware/SensorManager;

    iget-object v3, p0, Lcom/android/server/notification/NotificationManagerService;->mProximityListener:Landroid/hardware/SensorEventListener;
    ...
    .line 3863
    :goto_0
    iget-object v2, p0, Lcom/android/server/notification/NotificationManagerService;->mProximityWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-boolean v2, p0, Lcom/android/server/notification/NotificationManagerService;->mProximitySensorEnabled:Z
...
.method private enableProximityLockLocked()V
    ...
    iget-object v3, p0, Lcom/android/server/notification/NotificationManagerService;->mWakeUpScreenRunnable:Ljava/lang/Runnable;

    const-wide/16 v4, 0x12c

    invoke-virtual {v2, v3, v4, v5}, Lcom/android/server/notification/NotificationManagerService$WorkerHandler;->postDelayed(Ljava/lang/Runnable;J)Z

    .line 3838
    iget-object v2, p0, Lcom/android/server/notification/NotificationManagerService;->mHandler:Lcom/android/server/notification/NotificationManagerService$WorkerHandler;

    iget-object v3, p0, Lcom/android/server/notification/NotificationManagerService;->mDisableProximityRunnable:Ljava/lang/Runnable;
...
.method private notiBreathLightInit(Landroid/content/Context;Lcom/android/server/lights/LightsManager;)V
    .locals 3
    .param p1, "context"    # Landroid/content/Context;
    ...
    invoke-virtual {p2, v1}, Lcom/android/server/lights/LightsManager;->getLight(I)Lcom/android/server/lights/Light;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/notification/NotificationManagerService;->mButtonLight:Lcom/android/server/lights/Light;
...
.method private notiWakeupScreenInit(Landroid/content/Context;)V
    ...
    const-string v1, "PhoneWindowManager.mProximityWakeLock"
    ...
    .line 3941
    iput-boolean v4, p0, Lcom/android/server/notification/NotificationManagerService;->mIsLidOpened:Z

    .line 3942
    invoke-direct {p0}, Lcom/android/server/notification/NotificationManagerService;->registerLidCallback()V
...
.method private postDelayNotiLightFlashing()V
    ...
    .local v2, "identity":J
    :try_start_1
    iget-object v8, p0, Lcom/android/server/notification/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;

    if-eqz v8, :cond_0

    .line 3681
    iget-object v8, p0, Lcom/android/server/notification/NotificationManagerService;->mAlarmManager:Landroid/app/AlarmManager;

    iget-object v9, p0, Lcom/android/server/notification/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;

    invoke-virtual {v8, v9}, Landroid/app/AlarmManager;->cancel(Landroid/app/PendingIntent;)V

    .line 3683
    const-string v8, "LedTest"

    const-string v9, "cancel braodcast"
    ...
    const-string v10, "ledDoubleFlash = "
    ...
    .line 3690
    iget-boolean v8, p0, Lcom/android/server/notification/NotificationManagerService;->mBreathLightOn:Z
    ...
    iget-boolean v8, p0, Lcom/android/server/notification/NotificationManagerService;->mBreathLightDoubleFlashing:Z
    ...
    .line 3694
    .local v6, "whenToStartBreath":J
    new-instance v1, Landroid/content/Intent;

    const-string v8, "com.android.server.notification"

    invoke-direct {v1, v8}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 3695
    .local v1, "intent":Landroid/content/Intent;
    const-string v8, "ledDoubleFlash"
    ...
    invoke-virtual {v8, v9, v6, v7, v5}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V

    .line 3700
    iput-object v5, p0, Lcom/android/server/notification/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;

    .line 3702
    const-string v8, "LedTest"

    const-string v9, "breath light broadcast send!"
    ...
    .end local v6    # "whenToStartBreath":J
    :goto_0
    :try_start_2
    invoke-static {v2, v3}, Landroid/os/Binder;->restoreCallingIdentity(J)V

    .line 3713
    .end local v4    # "ledDoubleFlash":Z
    :goto_1
    monitor-exit p0
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    .line 3705
    .restart local v4    # "ledDoubleFlash":Z
    :cond_2
    :try_start_3
    const-string v8, "LedTest"

    const-string v9, "breath light is already flashing, do NOT wakeup again."
    ...
    const-string v9, "breath light broadcast send failed..."
...
.method private registerLidCallback()V
    ...
    :try_start_0
    new-instance v3, Lcom/android/server/notification/NotificationManagerService$15;

    invoke-direct {v3, p0}, Lcom/android/server/notification/NotificationManagerService$15;-><init>(Lcom/android/server/notification/NotificationManagerService;)V
    ...
    const-string v3, "NotiWakeupScreen"
...
.method private turnOffBreathLight()V
    ...
    const-string v1, "mNotificationLight.turnOffFlick() && turnOffDoubleFlick() called!"
...
.method private turnOnBreathLight(Z)V
    ...
    const-string v1, "mNotificationLight.turnOnDoubleFlick() called!"
    ...
    const-string v1, "mNotificationLight.turnOnFlick() called!"
...
.method public onStart()V
    ...
    check-cast v17, Lcom/android/server/lights/LightsManager;

    .line 985
    .local v17, "lights":Lcom/android/server/lights/LightsManager;
    const/4 v2, 0x4
    ...
    invoke-direct {v0, v2, v1}, Lcom/android/server/notification/NotificationManagerService;->notiBreathLightInit(Landroid/content/Context;Lcom/android/server/lights/LightsManager;)V
    ...
    invoke-direct {v0, v2}, Lcom/android/server/notification/NotificationManagerService;->notiWakeupScreenInit(Landroid/content/Context;)V
    ...
    .line 1036
    .local v13, "dm":Lcom/mediatek/common/dm/DmAgent;
    invoke-interface {v13}, Lcom/mediatek/common/dm/DmAgent;->isLockFlagSet()Z

    move-result v2

    move-object/from16 v0, p0

    iput-boolean v2, v0, Lcom/android/server/notification/NotificationManagerService;->mDmLock:Z
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1

    .line 1044
    .end local v12    # "binder":Landroid/os/IBinder;
    .end local v13    # "dm":Lcom/mediatek/common/dm/DmAgent;
    :cond_1
    :goto_1
    ...
    .end local v17    # "lights":Lcom/android/server/lights/LightsManager;
    ...
    .restart local v17    # "lights":Lcom/android/server/lights/LightsManager;
    ...
    const-string v3, "failed to get DM status!"
...
.method updateLightsLocked()V
    ...
    .line 2980
    iget-object v6, p0, Lcom/android/server/notification/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;

    if-eqz v6, :cond_3

    .line 2981
    iget-object v6, p0, Lcom/android/server/notification/NotificationManagerService;->mAlarmManager:Landroid/app/AlarmManager;

    iget-object v7, p0, Lcom/android/server/notification/NotificationManagerService;->mFlashSender:Landroid/app/PendingIntent;
