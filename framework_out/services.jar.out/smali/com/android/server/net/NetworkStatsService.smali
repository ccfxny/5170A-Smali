...
.method private updateIfacesLocked()V
    ...
    const-string v19, "updateIfacesLocked()"
    ...
    .line 917
    .local v17, "states":[Landroid/net/NetworkState;
    move-object/from16 v0, p0
    ...
    .line 931
    .local v16, "state":Landroid/net/NetworkState;
    move-object/from16 v0, v16
    ...
    .line 951
    .local v15, "stackedLinks":Ljava/util/List;, "Ljava/util/List<Landroid/net/LinkProperties;>;"
    ...
    .end local v15    # "stackedLinks":Ljava/util/List;, "Ljava/util/List<Landroid/net/LinkProperties;>;"
    .end local v16    # "state":Landroid/net/NetworkState;
    .end local v17    # "states":[Landroid/net/NetworkState;
    :catch_0
    move-exception v5
    ...
    .restart local v17    # "states":[Landroid/net/NetworkState;
    :cond_4
    const/16 v18, 0x0
    ...
    .restart local v16    # "state":Landroid/net/NetworkState;
    :cond_5
...
.method public forceUpdateIfaces()V
    ...
    const-string v3, "triggering delayed 1 second to updateIfaces"
