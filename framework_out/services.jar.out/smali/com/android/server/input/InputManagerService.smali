...
.field private mHolsterControl:Landroid/os/HolsterControl;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1918
    iput-object v3, p0, Lcom/android/server/input/InputManagerService;->mHolsterControl:Landroid/os/HolsterControl;
    ...
    invoke-direct {v1, p0, v3}, Lcom/android/server/input/InputManagerService$LocalService;-><init>(Lcom/android/server/input/InputManagerService;Lcom/android/server/input/InputManagerService$1;)V

    invoke-static {v0, v1}, Lcom/android/server/LocalServices;->addService(Ljava/lang/Class;Ljava/lang/Object;)V

    .line 295
    new-instance v0, Landroid/os/HolsterControl;

    invoke-direct {v0, p1}, Landroid/os/HolsterControl;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/input/InputManagerService;->mHolsterControl:Landroid/os/HolsterControl;
...
.method private static native nativeSetPointerPrimaryKey(JZ)V
.end method
...
.method private static native nativeSetSmartBookPlugIn(JZ)V
.end method
...
.method private notifyInputDevicesChanged([Landroid/view/InputDevice;)V
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/server/input/InputManagerService$InputManagerHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string v3, "Notification manager is not ready, set message pending"
...
.method private notifySwitch(JII)V
    ...
    .local v1, "lidOpen":Z
    :goto_0
    iget-object v4, p0, Lcom/android/server/input/InputManagerService;->mHolsterControl:Landroid/os/HolsterControl;
    ...
    invoke-virtual {v4, v1, v5}, Landroid/os/HolsterControl;->switchHandler(ZLjava/lang/String;)V
...
.method private showMissingKeyboardLayoutNotification(Landroid/view/InputDevice;)V
    ...
    iget-object v0, v7, Landroid/app/Notification$Builder;->mFlymeNotificationBuilder:Landroid/app/NotificationBuilderExt;
    ...
    invoke-virtual {v0, v4, v9, v1, v3}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    .end local v7    # "notification":Landroid/app/Notification$Builder;
...
.method public registerCallback(Landroid/hardware/input/ILidSwitchCallback;Ljava/lang/String;)V
    ...
    .prologue
    .line 1920
    iget-object v0, p0, Lcom/android/server/input/InputManagerService;->mHolsterControl:Landroid/os/HolsterControl;
    ...
    invoke-virtual {v0, p1, p2}, Landroid/os/HolsterControl;->registerCallback(Landroid/hardware/input/ILidSwitchCallback;Ljava/lang/String;)V
...
.method public setSmartBookPlugIn(Z)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/server/input/InputManagerService;->nativeSetSmartBookPlugIn(JZ)V
...
.method public systemRunning()V
    ...
    const-string v5, "Input Manager has "
...
.method public unregisterCallback(Landroid/hardware/input/ILidSwitchCallback;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/os/HolsterControl;->unregisterCallback(Landroid/hardware/input/ILidSwitchCallback;Ljava/lang/String;)V
...
.method public updatePointerPrimaryKeyFromSettings()V
    ...
    invoke-static {v2, v3, v0}, Lcom/android/server/input/InputManagerService;->nativeSetPointerPrimaryKey(JZ)V
