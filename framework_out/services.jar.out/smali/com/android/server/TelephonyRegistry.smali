...
.method private convertLteDcSubId(I)I
    .locals 3
    .param p1, "subId"    # I
    ...
    const-string v2, "convertLteDcSubId: convert subId from -999 to "
...
.method private handleCellCallback(Lcom/android/server/TelephonyRegistry$Record;)V
    .locals 5
    .param p1, "r"    # Lcom/android/server/TelephonyRegistry$Record;
    ...
    invoke-direct {p0, p1, v2}, Lcom/android/server/TelephonyRegistry;->validateEventsAndUserLocked(Lcom/android/server/TelephonyRegistry$Record;I)Z
    ...
    .line 967
    :try_start_0
    iget v2, p1, Lcom/android/server/TelephonyRegistry$Record;->callingPid:I

    iget v3, p1, Lcom/android/server/TelephonyRegistry$Record;->callingUid:I

    invoke-direct {p0, v2, v3}, Lcom/android/server/TelephonyRegistry;->isLocationPermissionGrandted(II)Z
    ...
    .line 968
    iget v1, p1, Lcom/android/server/TelephonyRegistry$Record;->phoneId:I

    .line 969
    .local v1, "phoneId":I
    iget-object v3, p1, Lcom/android/server/TelephonyRegistry$Record;->callback:Lcom/android/internal/telephony/IPhoneStateListener;
    ...
    invoke-interface {v3, v2}, Lcom/android/internal/telephony/IPhoneStateListener;->onCellInfoChanged(Ljava/util/List;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v2, v3}, Lcom/android/internal/telephony/IPhoneStateListener;->onCellLocationChanged(Landroid/os/Bundle;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    const-string v4, "PhoneStateListener.LISTEN_CELL_INFO deny callingPid:"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p1, Lcom/android/server/TelephonyRegistry$Record;->callingPid:I
    ...
    iget v4, p1, Lcom/android/server/TelephonyRegistry$Record;->callingUid:I
    ...
    const-string v4, "PhoneStateListener.LISTEN_CELL_LOCATION deny callingPid:"
...
.method private isLocationPermissionGrandted(II)Z
    .locals 1
    .param p1, "pid"    # I
    .param p2, "uid"    # I
    ...
    invoke-static {v0, p2, p1}, Lmeizu/security/FlymePermissionManager;->isFlymePermissionGranted(III)Z
...
.method private listen(Ljava/lang/String;Lcom/android/internal/telephony/IPhoneStateListener;IZI)V
    ...
    .line 533
    .local v8, "locationCellRecord":Lcom/android/server/TelephonyRegistry$Record;
    move-object/from16 v0, p0
    ...
    iput-object v0, v11, Lcom/android/server/TelephonyRegistry$Record;->pkgForDebug:Ljava/lang/String;

    .line 553
    iput v4, v11, Lcom/android/server/TelephonyRegistry$Record;->callerUid:I
    ...
    const-string v15, "listen:  Register r="
    ...
    const-string v15, " r.subId="

    invoke-virtual {v13, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v13

    iget v15, v11, Lcom/android/server/TelephonyRegistry$Record;->subId:I
    ...
    invoke-direct {v0, v13}, Lcom/android/server/TelephonyRegistry;->toStringLogSSC(Ljava/lang/String;)V
    ...
    const-string v15, "listen: call onSSC state="
    ...
    :cond_1
    invoke-interface {v13, v6}, Lcom/android/internal/telephony/IPhoneStateListener;->onSignalStrengthChanged(I)V
    :try_end_4
    ...
    iget-object v15, v0, Lcom/android/server/TelephonyRegistry;->mDcRtInfo:Landroid/telephony/DataConnectionRealTimeInfo;

    invoke-interface {v13, v15}, Lcom/android/internal/telephony/IPhoneStateListener;->onDataConnectionRealTimeInfoChanged(Landroid/telephony/DataConnectionRealTimeInfo;)V
    :try_end_e
    ...
    invoke-direct {v0, v8}, Lcom/android/server/TelephonyRegistry;->handleCellCallback(Lcom/android/server/TelephonyRegistry$Record;)V

    .line 701
    .end local v2    # "N":I
    .end local v3    # "b":Landroid/os/IBinder;
    .end local v7    # "i":I
    .end local v8    # "locationCellRecord":Lcom/android/server/TelephonyRegistry$Record;
    ...
    .restart local v8    # "locationCellRecord":Lcom/android/server/TelephonyRegistry$Record;
    .restart local v11    # "r":Lcom/android/server/TelephonyRegistry$Record;
    :cond_10
    ...
    invoke-direct {v11}, Lcom/android/server/TelephonyRegistry$Record;-><init>()V
    :try_end_12
    ...
    .line 548
    const-string v13, "listen: add new record"
    ...
    .end local v11    # "r":Lcom/android/server/TelephonyRegistry$Record;
    :cond_13
    const-string v13, "listen: Unregister"
...
.method public addOnSubscriptionsChangedListener(Ljava/lang/String;Lcom/android/internal/telephony/IOnSubscriptionsChangedListener;)V
    ...
    invoke-direct {v6}, Lcom/android/server/TelephonyRegistry$Record;-><init>()V
    :try_end_5
...
.method public getPhoneSubIdMapping(I)I
    ...
    .line 1801
    const-string v2, "getPhoneSubIdMapping mapping phone ID for IRAT."
...
.method public notifyCellInfoForSubscriber(ILjava/util/List;)V
    ...
    .line 936
    iget v4, v3, Lcom/android/server/TelephonyRegistry$Record;->callingPid:I

    iget v6, v3, Lcom/android/server/TelephonyRegistry$Record;->callingPid:I

    invoke-direct {p0, v4, v6}, Lcom/android/server/TelephonyRegistry;->isLocationPermissionGrandted(II)Z
    ...
    const-string v7, "notifyCellInfoForSubscriber deny callingPid:"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, v3, Lcom/android/server/TelephonyRegistry$Record;->callingPid:I
...
.method public notifyCellLocationForSubscriber(ILandroid/os/Bundle;)V
    ...
    const-string v7, "notifyCellInfoForSubscriber Bundle deny callingPid:"
...
.method public notifyDataConnectionFailedForSubscriber(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 1289
    invoke-direct/range {p0 .. p1}, Lcom/android/server/TelephonyRegistry;->convertLteDcSubId(I)I
...
.method public notifyDataConnectionForSubscriber(IIZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/NetworkCapabilities;IZ)V
    ...
    const-string v3, "notifyDataConnectionForSubscriber: convert subId = "
