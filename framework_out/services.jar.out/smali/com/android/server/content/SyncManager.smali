...
.field private static final MZ_MINI_ACCOUNT_CHANGE:J = 0x3e8L

.field private static final MZ_MINI_PERIOD_MILLIS:J = 0x2932e00L
...
.field private mLastAccountChange:J
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-wide v0, p0, Lcom/android/server/content/SyncManager;->mLastAccountChange:J
...
.method static synthetic access$2800(Lcom/android/server/content/SyncManager;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$300(Lcom/android/server/content/SyncManager;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;

    .prologue
    .line 118
    iget-wide v0, p0, Lcom/android/server/content/SyncManager;->mLastAccountChange:J
...
.method static synthetic access$302(Lcom/android/server/content/SyncManager;J)J
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # J
    ...
    .prologue
    .line 118
    iput-wide p1, p0, Lcom/android/server/content/SyncManager;->mLastAccountChange:J
...
.method static synthetic access$3400(Lcom/android/server/content/SyncManager;)Landroid/net/ConnectivityManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$3500(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Lcom/android/server/content/SyncManager$ActiveSyncContext;
...
.method static synthetic access$3800(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;J)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Lcom/android/server/content/SyncOperation;
    .param p2, "x2"    # J
...
.method static synthetic access$3900(Lcom/android/server/content/SyncManager;)Landroid/app/NotificationManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4000(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Lcom/android/server/content/SyncManager$ActiveSyncContext;
...
.method static synthetic access$4200(Lcom/android/server/content/SyncManager;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4202(Lcom/android/server/content/SyncManager;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
    .param p1, "x1"    # Z
...
.method static synthetic access$4300(Lcom/android/server/content/SyncManager;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4400(Lcom/android/server/content/SyncManager;)Landroid/app/PendingIntent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4500(Lcom/android/server/content/SyncManager;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method static synthetic access$4600(Lcom/android/server/content/SyncManager;Landroid/os/UserHandle;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/content/SyncManager;
...
.method public updateRunningAccounts()V
    ...
    iput-object v5, p0, Lcom/android/server/content/SyncManager;->mRunningAccounts:[Landroid/accounts/AccountAndUser;

    .line 327
    iget-boolean v5, p0, Lcom/android/server/content/SyncManager;->mBootCompleted:Z
    ...
    .line 335
    .local v1, "cancelList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/content/SyncManager$ActiveSyncContext;>;"
    const/4 v3, 0x0

    .local v3, "i":I
    :goto_0
    iget-object v5, p0, Lcom/android/server/content/SyncManager;->mActiveSyncContexts:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0, v5, v6}, Lcom/android/server/content/SyncManager;->containsAccountAndUser([Landroid/accounts/AccountAndUser;Landroid/accounts/Account;I)Z
    ...
    const-string v6, "canceling sync since the account is no longer running"
    ...
    .line 352
    .restart local v2    # "currentSyncContext":Lcom/android/server/content/SyncManager$ActiveSyncContext;
    const/4 v5, 0x0

    invoke-direct {p0, v2, v5}, Lcom/android/server/content/SyncManager;->sendSyncFinishedOrCanceledMessage(Lcom/android/server/content/SyncManager$ActiveSyncContext;Landroid/content/SyncResult;)V
