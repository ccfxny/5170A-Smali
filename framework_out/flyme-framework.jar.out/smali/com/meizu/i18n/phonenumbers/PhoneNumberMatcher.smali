...
.method static allNumberGroupsAreExactlyPresent(Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/StringBuilder;[Ljava/lang/String;)Z
    ...
    .line 492
    sget-object v5, Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;->NON_DIGITS_PATTERN:Ljava/util/regex/Pattern;
...
.method static checkNumberGroupingIsValid(Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher$NumberGroupingChecker;)Z
    ...
    .line 551
    invoke-static {p1, v5}, Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;->normalizeDigits(Ljava/lang/String;Z)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2, p0, v6}, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher;->getNationalNumberGroups(Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;Lcom/meizu/i18n/phonenumbers/Phonemetadata$NumberFormat;)[Ljava/lang/String;

    move-result-object v2

    .line 554
    .local v2, "formattedNumberGroups":[Ljava/lang/String;
    invoke-interface {p3, p2, p0, v4, v2}, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher$NumberGroupingChecker;->checkGroups(Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/StringBuilder;[Ljava/lang/String;)Z
    ...
    invoke-static {v6}, Lcom/meizu/i18n/phonenumbers/MetadataManager;->getAlternateFormatsForCountry(I)Lcom/meizu/i18n/phonenumbers/Phonemetadata$PhoneMetadata;

    move-result-object v1

    .line 560
    .local v1, "alternateFormats":Lcom/meizu/i18n/phonenumbers/Phonemetadata$PhoneMetadata;
    if-eqz v1, :cond_2

    .line 561
    invoke-virtual {v1}, Lcom/meizu/i18n/phonenumbers/Phonemetadata$PhoneMetadata;->numberFormats()Ljava/util/List;
...
.method static containsOnlyValidXChars(Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;)Z
    ...
    invoke-virtual {p2, p0, v4}, Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;->isNumberMatch(Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;)Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil$MatchType;

    move-result-object v4

    sget-object v5, Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil$MatchType;->NSN_MATCH:Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil$MatchType;
...
.method private extractInnerMatch(Ljava/lang/String;I)Lcom/meizu/i18n/phonenumbers/PhoneNumberMatch;
    ...
    .restart local v3    # "match":Lcom/meizu/i18n/phonenumbers/PhoneNumberMatch;
    :cond_1
...
.method private find(I)Lcom/meizu/i18n/phonenumbers/PhoneNumberMatch;
    ...
    .restart local v1    # "match":Lcom/meizu/i18n/phonenumbers/PhoneNumberMatch;
...
.method static isNationalPrefixPresentIfRequired(Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;)Z
    ...
    sget-object v9, Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber$CountryCodeSource;->FROM_DEFAULT_COUNTRY:Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber$CountryCodeSource;
    ...
    invoke-virtual {p1, v8}, Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;->getRegionCodeForCountryCode(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v8, v3}, Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;->chooseFormattingPatternForNumber(Ljava/util/List;Ljava/lang/String;)Lcom/meizu/i18n/phonenumbers/Phonemetadata$NumberFormat;
    ...
    invoke-virtual {p1, v5, v2, v7}, Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;->maybeStripNationalPrefixAndCarrierCode(Ljava/lang/StringBuilder;Lcom/meizu/i18n/phonenumbers/Phonemetadata$PhoneMetadata;Ljava/lang/StringBuilder;)Z
...
.method private parseAndVerify(Ljava/lang/String;I)Lcom/meizu/i18n/phonenumbers/PhoneNumberMatch;
    ...
    invoke-static {v3}, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher;->isInvalidPunctuationSymbol(C)Z

    move-result v5

    if-nez v5, :cond_0

    invoke-static {v3}, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher;->isLatinLetter(C)Z
    ...
    .line 412
    .local v1, "nextChar":C
    invoke-static {v1}, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher;->isInvalidPunctuationSymbol(C)Z

    move-result v5

    if-nez v5, :cond_0

    invoke-static {v1}, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher;->isLatinLetter(C)Z
    ...
    .line 419
    .local v2, "number":Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;
    iget-object v5, p0, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher;->leniency:Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil$Leniency;

    iget-object v6, p0, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatcher;->phoneUtil:Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;

    invoke-virtual {v5, v2, p1, v6}, Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil$Leniency;->verify(Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;Lcom/meizu/i18n/phonenumbers/PhoneNumberUtil;)Z
    ...
    invoke-direct {v5, p2, p1, v2}, Lcom/meizu/i18n/phonenumbers/PhoneNumberMatch;-><init>(ILjava/lang/String;Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;)V
    :try_end_0
    ...
    .line 428
    .end local v2    # "number":Lcom/meizu/i18n/phonenumbers/Phonenumber$PhoneNumber;
    :catch_0
    move-exception v5
