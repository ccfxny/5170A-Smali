...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    .line 655
    const-string v25, "case 1 : new Call appear"
    ...
    const-string v26, "poll: pendingMO="
    ...
    const-string v26, "poll: hangupPendingMO, hangup conn "
    ...
    .line 616
    const-string v25, "SRVCC: +ECONFSRVCC is still not arrival, skip this poll call."
    ...
    const-string v25, "GsmCallTracker"

    const-string v26, "unexpected error on hangup"
    ...
    .line 694
    const-string v25, "MO/MT conflict! MO should be hangup by MD"
    ...
    new-instance v26, Lcom/android/internal/telephony/gsm/GsmConnection;
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/internal/telephony/gsm/GsmConnection;->setCnapName(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->DmCheckIfCallCanComing(Lcom/android/internal/telephony/gsm/GsmConnection;)Z
    ...
    .line 727
    invoke-virtual {v15}, Lcom/android/internal/telephony/Connection;->isMultipartyBeforeHandover()Z
    ...
    const-string v26, "SRVCC: goes to conference case."
    ...
    iput-object v15, v0, Lcom/android/internal/telephony/gsm/GsmConnection;->mOrigConnection:Lcom/android/internal/telephony/Connection;
    ...
    const-string v26, "SRVCC: goes to normal call case."
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;)V
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GsmConnection;->getCall()Lcom/android/internal/telephony/gsm/GsmCall;
    ...
    const-string v27, "Phantom call appeared "
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GsmConnection;->onConnectedInOrOut()V
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GsmConnection;->onStartedHolding()V
    ...
    .line 770
    const-string v25, "case 2 : old Call disappear"
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GsmCall;->isIdle()Z
    ...
    sget-object v26, Lcom/android/internal/telephony/Call$State;->WAITING:Lcom/android/internal/telephony/Call$State;
    ...
    sget-object v26, Lcom/android/internal/telephony/Call$State;->INCOMING:Lcom/android/internal/telephony/Call$State;
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->CallIndicationEnd()V
    ...
    .line 799
    const-string v25, "case 3 : old Call replaced"
    ...
    .line 821
    const-string v25, "case 4 : old Call update"
    ...
    const-string v27, "Pending MO dropped before poll fg state:"
    ...
    .line 867
    const-string v25, "notifyNewRingingConnection"
    ...
    const-string v26, "dropped during poll size = "
    ...
    const-string v26, "missed/rejected call, conn.cause="
    ...
    const-string v26, "setting cause to "
    ...
    .line 902
    :cond_1e
    const-string v25, "local hangup or invalid number"
    ...
    .line 911
    .local v16, "hostConn":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    move-object/from16 v0, p0
    ...
    .line 918
    const-string v25, "srvcc: notify new participant connections"
    ...
    .line 948
    .end local v16    # "hostConn":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    :cond_20
    move-object/from16 v0, p0
    ...
    const-string v26, "handlePollCalls - disconnect hoConn= "
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->onDisconnect(I)Z
    ...
    .restart local v16    # "hostConn":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    :cond_21
    move-object/from16 v0, p0
    ...
    check-cast v22, Lcom/android/internal/telephony/gsm/GsmConnection;

    .line 925
    .local v22, "participant":Lcom/android/internal/telephony/gsm/GsmConnection;
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/telephony/gsm/GsmConnection;->isIncoming()Z
    ...
    .line 927
    const-string v25, "srvcc: conference participant case."
    ...
    .line 936
    :goto_c
    const-string v25, "srvcc: only one connection, consider it as a normal call SRVCC"
    ...
    const-string v26, "srvcc: restore participant connection with address: "
    ...
    .end local v22    # "participant":Lcom/android/internal/telephony/gsm/GsmConnection;
    :cond_23
    const-string v25, "GsmCallTracker"

    const-string v26, "SRVCC: abnormal case, no participant connections."
    ...
    invoke-interface/range {v25 .. v26}, Lcom/android/internal/telephony/CommandsInterface;->getLastCallFailCause(Landroid/os/Message;)V
    ...
    .line 976
    const-string v25, "notifyUnknownConnection"
    ...
    .line 984
    const-string v25, "notifyPreciseCallStateChanged"
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyPreciseCallStateChanged()V
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->getCurrentTotalConnections()I
