...
.method private logBootEvents(Landroid/content/Context;)V
    ...
    const-string v6, "meizu.intent.action.FLYME_RESTART"
    ...
    check-cast v14, Lmeizu/os/DeviceControlManager;

    .line 171
    .local v14, "control":Lmeizu/os/DeviceControlManager;
    if-eqz v14, :cond_3

    .line 172
    const/4 v6, 0x0

    invoke-virtual {v14, v6}, Lmeizu/os/DeviceControlManager;->countAsRestart(I)I

    goto :goto_1

    .line 188
    .end local v14    # "control":Lmeizu/os/DeviceControlManager;
