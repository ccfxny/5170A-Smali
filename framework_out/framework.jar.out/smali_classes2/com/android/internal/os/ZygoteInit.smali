...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/os/ZygoteInit$Injector;,
...
.field private static final ENABLE_SYSTEM_BACKTRACE:Z
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lcom/android/internal/os/ZygoteInit;->heapgrowthlimit:Ljava/lang/String;

    .line 107
    sget-object v2, Lcom/android/internal/os/ZygoteInit;->heapgrowthlimit:Ljava/lang/String;

    sget-object v3, Lcom/android/internal/os/ZygoteInit;->heapgrowthlimit:Ljava/lang/String;
    ...
    sput v2, Lcom/android/internal/os/ZygoteInit;->PRELOAD_GC_THRESHOLD:I
    ...
    :goto_0
    sput-boolean v0, Lcom/android/internal/os/ZygoteInit;->ENABLE_SYSTEM_BACKTRACE:Z
...
.method public static main([Ljava/lang/String;)V
    ...
    sput-boolean v3, Lcom/android/internal/os/ZygoteInit;->MTPROF_DISABLE:Z
    ...
    .line 739
    .local v17, "startSystemServer":Z
    const-string v16, "zygote"

    .line 740
    .local v16, "socketName":Ljava/lang/String;
    const/4 v2, 0x0
    ...
    const-string v5, "Unknown command line argument: "
    ...
    .end local v15    # "i":I
    .end local v16    # "socketName":Ljava/lang/String;
    .end local v17    # "startSystemServer":Z
    :catch_0
    move-exception v12

    .line 805
    .local v12, "caller":Lcom/android/internal/os/ZygoteInit$MethodAndArgsCaller;
    invoke-virtual {v12}, Lcom/android/internal/os/ZygoteInit$MethodAndArgsCaller;->run()V

    .line 811
    .end local v12    # "caller":Lcom/android/internal/os/ZygoteInit$MethodAndArgsCaller;
    :goto_2
    return-void
    ...
    .restart local v16    # "socketName":Ljava/lang/String;
    .restart local v17    # "startSystemServer":Z
    :cond_3
    if-nez v2, :cond_4
    ...
    :cond_4
    :try_start_2
    invoke-static/range {v16 .. v16}, Lcom/android/internal/os/ZygoteInit;->registerZygoteSocket(Ljava/lang/String;)V
    ...
    const-string v4, "Zygote:Preload Start"

    invoke-direct {v3, v4}, Ljava/lang/String;-><init>(Ljava/lang/String;)V

    invoke-static {v3}, Lcom/android/internal/os/ZygoteInit;->addBootEvent(Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Lcom/android/internal/os/ZygoteInit;->startSystemServer(Ljava/lang/String;Ljava/lang/String;)Z

    .line 785
    :cond_5
    sget-boolean v3, Lcom/android/internal/os/ZygoteInit;->ENABLE_SYSTEM_BACKTRACE:Z
    :try_end_2
    ...
    :goto_3
    :try_start_4
    const-string v3, "persist.sys.perf.reflect_check"
    ...
    sput-boolean v3, Ljava/lang/Class;->dumpReflectLogable:Z
    ...
    .line 801
    invoke-static {v2}, Lcom/android/internal/os/ZygoteInit;->runSelectLoop(Ljava/lang/String;)V
    ...
    const-string v4, "zygote PR_SET_DUMPABLE fail !!  "
...
.method static preload()V
    ...
    const-string v1, "preloadMappingTable() -- start "
    ...
    const-string v1, "preloadMappingTable() -- end "
    ...
    .line 316
    # invokes: Lcom/android/internal/os/ZygoteInit$Injector;->mzPreload()V
    invoke-static {}, Lcom/android/internal/os/ZygoteInit$Injector;->access$000()V
...
.method private static preloadResources()V
    ...
    .prologue
    .line 449
    const-string v6, "persist.perf.preload_res"
...
.method private static startSystemServer(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 685
    sget-boolean v1, Lcom/android/internal/os/ZygoteInit;->ENABLE_SYSTEM_BACKTRACE:Z

    if-eqz v1, :cond_0

    .line 686
    iget v1, v14, Lcom/android/internal/os/ZygoteConnection$Arguments;->debugFlags:I

    or-int/lit8 v1, v1, 0x1

    iput v1, v14, Lcom/android/internal/os/ZygoteConnection$Arguments;->debugFlags:I
