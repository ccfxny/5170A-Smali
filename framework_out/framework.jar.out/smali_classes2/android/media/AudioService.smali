...
.field private static final MSG_BTA2DP_SERVICE_DISCONNECT:I = 0x1a
...
.field private static final MSG_MUTE_SET_AFFECT_MUSIC:I = 0x19
...
.field private static final MSG_RINGMODE_SET_AFFECT_MUSIC:I = 0x18
...
.field private static final MSG_SET_LAST_MUSIC_SPEAKER_VOLUME:I = 0x1b
...
# instance fields
.field private final MONITOR_DURATION_TIME_MS:I
...
.field private mMonitorSucceed:Z
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/media/AudioService;->mCanResumeNormalStreams:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 5880
    iput v6, p0, Landroid/media/AudioService;->mSafeMediaVolumeDevices:I
    ...
    iput v0, p0, Landroid/media/AudioService;->MONITOR_DURATION_TIME_MS:I
    ...
    .line 698
    invoke-direct {p0}, Landroid/media/AudioService;->MzReadAndSetHifiParam()V

    .line 699
    invoke-direct {p0}, Landroid/media/AudioService;->MzCreateMediaserverWatchdogThread()V
...
.method private MzCreateMediaserverWatchdogThread()V
    .locals 2

    .prologue
    .line 6983
    iget-boolean v0, p0, Landroid/media/AudioService;->mThreadIsRunning:Z
    ...
    invoke-direct {v1, p0}, Landroid/media/AudioService$5;-><init>(Landroid/media/AudioService;)V
...
.method private MzReadAndSetHifiParam()V
    ...
    .line 6888
    .local v3, "isHifiOn":Z
    const-string v4, "ro.meizu.hardware.hifi"
    ...
    const-string v6, "MzReadAndSetHifiParam: hifiEnable = "
    ...
    const-string v5, "hifi_music_param"
    ...
    .line 6896
    .local v0, "gainKeyPairs":Ljava/lang/String;
    ...
    const-string v7, "MzReadAndSetHifiParam: hifi_state=on | "
    ...
    :cond_2
    :try_start_1
    const-string v4, "hifi_state=off"
    ...
    const-string v6, "MzReadAndSetHifiParam: hifi_state=off"
...
.method private MzcheckResumeRingerModeNormal(IZ)Z
    ...
    const-string v3, "MzcheckResumeRingerModeNormal: streamType = "
    ...
    sget v2, Landroid/media/AudioService;->mCanResumeNormalStreams:I
    ...
    .line 6878
    :cond_0
    invoke-direct {p0, v4, v0}, Landroid/media/AudioService;->setRingerModeInt(IZ)V

    .line 6879
    invoke-direct {p0, v4}, Landroid/media/AudioService;->setRingerModeExt(I)V
...
.method static synthetic access$10100(Landroid/media/AudioService;)Landroid/media/AudioService$VolumeController;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10200(Landroid/media/AudioService;)Landroid/media/AudioManagerInternal$RingerModeDelegate;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10202(Landroid/media/AudioService;Landroid/media/AudioManagerInternal$RingerModeDelegate;)Landroid/media/AudioManagerInternal$RingerModeDelegate;
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10600(Landroid/media/AudioService;ZILjava/lang/String;Landroid/os/IBinder;I)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # I
...
.method static synthetic access$10708(Landroid/media/AudioService;)I
    .locals 2
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10902(Landroid/media/AudioService;Z)Z
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 139
    iput-boolean p1, p0, Landroid/media/AudioService;->mThreadIsRunning:Z
...
.method static synthetic access$11000(Landroid/media/AudioService;)Z
    ...
    .prologue
    .line 139
    iget-boolean v0, p0, Landroid/media/AudioService;->mMonitorSucceed:Z
...
.method static synthetic access$11002(Landroid/media/AudioService;Z)Z
    ...
    .prologue
    .line 139
    iput-boolean p1, p0, Landroid/media/AudioService;->mMonitorSucceed:Z
...
.method static synthetic access$3100(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$3400(Landroid/media/AudioService;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$5900(Landroid/media/AudioService;Ljava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
...
.method static synthetic access$9400(Landroid/media/AudioService;)Landroid/media/AudioService$AudioOrientationEventListener;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$9500(Landroid/media/AudioService;Landroid/content/Context;)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$9600(Landroid/media/AudioService;)Landroid/media/MediaFocusControl;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method private adjustStreamVolume(IIILjava/lang/String;I)V
    ...
    invoke-direct {v0, v1, v5}, Landroid/media/AudioService;->MzcheckResumeRingerModeNormal(IZ)Z
    ...
    invoke-virtual {v0, v1, v5, v6, v2}, Landroid/media/AudioService;->setStreamVolume(IIILjava/lang/String;)V
    ...
    const-string v7, "[GJ_DEBUG] adjustStreamVolume: streamType = "
    ...
    invoke-static {v10}, Landroid/media/AudioService$VolumeStreamState;->access$900(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-virtual {v10, v8}, Landroid/media/AudioService$VolumeStreamState;->getSettingNameForDevice(I)Ljava/lang/String;
    ...
    .line 1239
    .local v16, "settingNameForDevice":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1262
    .end local v16    # "settingNameForDevice":Ljava/lang/String;
...
.method private checkSendBecomingNoisyIntent(II)I
    ...
    iget v2, v0, Landroid/media/AudioService;->mBecomingNoisyIntentDevices:I
    ...
    invoke-virtual {v2, v3}, Landroid/media/AudioService$AudioHandler;->hasMessages(I)Z
    ...
    .line 5168
    .local v14, "time":J
    sget-object v2, Landroid/media/AudioService;->mLastDeviceConnectMsgTime:Ljava/lang/Long;
...
.method private getActiveStreamType(I)I
    ...
    const-string v1, "getActiveStreamType: Ring is active, so return STREAM_RING"
    ...
    const-string v1, "getActiveStreamType:getActiveStreamType: Forcing STREAM_BLUETOOTH_SCO"
    ...
    const-string v2, "getActiveStreamType: Voice_call is active, so return STREAM_VOICE_CALL"
...
.method private isInCommunication()Z
    ...
    const-string v6, "[GJ_DEBUG] isInCommunication: isInCall = "
...
.method private onSetA2dpSinkConnectionState(Landroid/bluetooth/BluetoothDevice;I)V
    ...
    const-string v1, "[GJ_DEBUG] onSetA2dpSinkConnectionState: makeA2dpDeviceUnavailableNow ----1"
    ...
    const-string v1, "[GJ_DEBUG] onSetA2dpSinkConnectionState: makeA2dpDeviceUnavailableNow ----2"
...
.method private onSetStreamVolume(IIII)V
    ...
    invoke-direct {p0, v0, p2, p4, v1}, Landroid/media/AudioService;->setStreamVolumeInt(IIIZ)V
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    .line 5276
    invoke-virtual {p0}, Landroid/media/AudioService;->MzAddUsbAudioIntent()V
    ...
    .line 5279
    invoke-virtual {p0}, Landroid/media/AudioService;->MzRemoveUsbAudioIntent()V
...
.method private readAudioSettings(Z)V
    ...
    invoke-static {v3}, Landroid/media/AudioService$VolumeStreamState;->access$2300(Landroid/media/AudioService$VolumeStreamState;)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v7}, Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;->access$2402(Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;I)I
...
.method private setModeInt(ILandroid/os/IBinder;I)I
    ...
    const-string v14, "setModeInt mMode = "

    invoke-virtual {v13, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v13

    iget v14, p0, Landroid/media/AudioService;->mMode:I
...
.method private setRingerMode(ILjava/lang/String;Z)V
    ...
    const-string v6, "[GJ_DEBUG] setRingerMode: ringerMode = "
    ...
    const-string v7, "[GJ_DEBUG] setRingerMode: ringerModeInternal = "
...
.method private setRingerModeInt(IZ)V
    ...
    invoke-static {v2}, Landroid/media/AudioService$VolumeStreamState;->access$1300(Landroid/media/AudioService$VolumeStreamState;)Ljava/util/concurrent/ConcurrentHashMap;
...
.method private setStreamVolume(IIILjava/lang/String;I)V
    ...
    invoke-virtual {v0, v1}, Landroid/media/AudioService$VolumeStreamState;->getSettingNameForDevice(I)Ljava/lang/String;
    ...
    .line 1412
    .local v10, "settingNameForDevice":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1423
    .end local v10    # "settingNameForDevice":Ljava/lang/String;
    :cond_3
    const/4 v5, 0x3
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/media/AudioService;->checkSafeMediaVolume(III)Z
    ...
    .line 1459
    new-instance v11, Landroid/media/AudioService$StreamVolumeCommand;
    ...
    invoke-direct/range {v11 .. v16}, Landroid/media/AudioService$StreamVolumeCommand;-><init>(Landroid/media/AudioService;IIII)V

    move-object/from16 v0, p0

    iput-object v11, v0, Landroid/media/AudioService;->mPendingVolumeCommand:Landroid/media/AudioService$StreamVolumeCommand;
    ...
    const-string v7, "[GJ_DEBUG] setStreamVolume: streamType = "
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Landroid/media/AudioService;->onSetStreamVolume(IIII)V
    ...
    invoke-virtual {v5, v0}, Landroid/media/AudioService$VolumeStreamState;->getIndex(I)I
    :try_end_5
...
# virtual methods
.method protected MzAddUsbAudioIntent()V
    .locals 11
    ...
    const v6, 0xa0a0149    # 6.6447E-33f
    ...
    .line 6919
    iget-object v6, v3, Landroid/app/Notification;->mFlymeNotification:Landroid/app/NotificationExt;

    iput v9, v6, Landroid/app/NotificationExt;->notificationIcon:I
...
.method protected MzRemoveUsbAudioIntent()V
    .locals 2
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p2}, Landroid/media/MediaFocusControl;->dump(Ljava/io/PrintWriter;)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->streamToString(I)Ljava/lang/String;
    ...
    .line 6123
    const-string v1, "  mVolumeController="
    ...
    invoke-static {v1}, Landroid/media/AudioService;->safeMediaVolumeStateToString(Ljava/lang/Integer;)Ljava/lang/String;
    ...
    .line 6128
    const-string v1, "  mMusicActiveMs="

    invoke-virtual {p2, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v1, p0, Landroid/media/AudioService;->mMusicActiveMs:I
...
.method public forceVolumeControlStream(ILandroid/os/IBinder;)V
    ...
    const-string v2, "[GJ_DEBUG] forceVolumeControlStream: streamType = "
...
.method public mzSwitchBluetoothToDevice(I)V
    ...
    .line 6961
    const-string v0, "mzSwitchBluetoothToDevice()"
...
.method public setBluetoothA2dpDeviceConnectionState(Landroid/bluetooth/BluetoothDevice;II)I
    ...
    const-string v2, "[GJ_DEBUG] setBluetoothA2dpDeviceConnectionState: device = "
...
.method public setMode(ILandroid/os/IBinder;)V
    ...
    const-string v4, "setMode mMode = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Landroid/media/AudioService;->mMode:I
...
.method public setVolumeController(Landroid/media/IVolumeController;)V
    ...
    const-string v2, "[GJ_DEBUG] Volume controller: "
