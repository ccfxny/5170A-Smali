...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$8100(Landroid/media/AudioService;)V
    :try_end_1
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$3100(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9400(Landroid/media/AudioService;)Landroid/media/AudioService$AudioOrientationEventListener;
    ...
    invoke-static {v3, v0}, Landroid/media/AudioService;->access$9500(Landroid/media/AudioService;Landroid/content/Context;)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9600(Landroid/media/AudioService;)Landroid/media/MediaFocusControl;
    ...
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$9700(Landroid/media/AudioService;Z)V
    ...
    invoke-static {v8}, Landroid/media/AudioService;->access$4800(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;
