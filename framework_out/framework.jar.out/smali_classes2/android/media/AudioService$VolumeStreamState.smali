...
.method public readSettings()V
    ...
    # getter for: Landroid/media/AudioService;->mUseMasterVolume:Z
    invoke-static {v6}, Landroid/media/AudioService;->access$4200(Landroid/media/AudioService;)Z
    ...
    .line 3775
    sget-object v6, Landroid/media/AudioService;->DEFAULT_STREAM_VOLUME:[I
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$3100(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v6, v4, v3, v8}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    iget v6, v6, Landroid/media/AudioService;->mFixedVolumeDevices:I
...
.method public setAllIndexesForMusic(Ljava/lang/String;ZZ)V
    ...
    .line 3996
    :cond_2
    sget-object v7, Landroid/media/AudioService;->DEFAULT_STREAM_VOLUME:[I
    ...
    # getter for: Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    invoke-static {v7}, Landroid/media/AudioService;->access$3100(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v7, v9, v4, v10}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    invoke-static {v7, v5, v4, v9}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

    .line 4011
    mul-int/lit8 v7, v4, 0xa

    invoke-direct {p0, v7}, Landroid/media/AudioService$VolumeStreamState;->getValidIndex(I)I
    ...
    invoke-static {v7, v9, v0, v10}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
