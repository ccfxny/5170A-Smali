...
.field public static final MOBILE_DATA_DEFAULT:I
...
.method static constructor <clinit>()V
    ...
    .line 3851
    const-string v2, "content://settings/secure"
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/provider/Settings$NameValueCache;-><init>(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-object v2, Landroid/provider/Settings$Secure;->MOVED_TO_LOCK_SETTINGS:Ljava/util/HashSet;
    ...
    sput-object v2, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;

    .line 3873
    sget-object v2, Landroid/provider/Settings$Secure;->MOVED_TO_GLOBAL:Ljava/util/HashSet;
    ...
    const-string/jumbo v3, "subscription_mode"
    ...
    const-string v3, "download_manager_max_bytes_over_mobile"
    ...
    const-string v3, "download_manager_recommended_max_bytes_over_mobile"
    ...
    const-string/jumbo v3, "netstats_dev_bucket_duration"
    ...
    const-string/jumbo v3, "netstats_dev_delete_age"
    ...
    const-string/jumbo v3, "netstats_dev_persist_bytes"
    ...
    const-string/jumbo v3, "netstats_dev_rotate_age"
    ...
    const-string/jumbo v3, "netstats_enabled"
    ...
    const-string/jumbo v3, "netstats_global_alert_bytes"
    ...
    const-string/jumbo v3, "netstats_poll_interval"
    ...
    const-string/jumbo v3, "netstats_sample_enabled"
    ...
    const-string/jumbo v3, "netstats_time_cache_max_age"
    ...
    const-string/jumbo v3, "netstats_uid_bucket_duration"
    ...
    const-string/jumbo v3, "netstats_uid_delete_age"
    ...
    const-string/jumbo v3, "netstats_uid_persist_bytes"
    ...
    const-string/jumbo v3, "netstats_uid_rotate_age"
    ...
    const-string/jumbo v3, "netstats_uid_tag_bucket_duration"
    ...
    const-string/jumbo v3, "netstats_uid_tag_delete_age"
    ...
    const-string/jumbo v3, "netstats_uid_tag_persist_bytes"
    ...
    const-string/jumbo v3, "netstats_uid_tag_rotate_age"
    ...
    const-string/jumbo v3, "pdp_watchdog_error_poll_count"
    ...
    const-string/jumbo v3, "pdp_watchdog_long_poll_interval_ms"
    ...
    const-string/jumbo v3, "pdp_watchdog_max_pdp_reset_fail_count"
    ...
    const-string/jumbo v3, "pdp_watchdog_poll_interval_ms"
    ...
    const-string/jumbo v3, "sampling_profiler_ms"
    ...
    const-string/jumbo v3, "setup_prepaid_data_service_url"
    ...
    const-string/jumbo v3, "setup_prepaid_detection_redir_host"
    ...
    const-string/jumbo v3, "setup_prepaid_detection_target_url"
    ...
    const-string/jumbo v3, "wifi_networks_available_repeat_delay"
    ...
    const-string/jumbo v3, "wifi_enhanced_auto_join"
    ...
    const-string/jumbo v3, "wifi_network_show_rssi"
    ...
    const-string/jumbo v3, "wimax_networks_available_notification_on"
    ...
    const-string/jumbo v3, "verifier_timeout"
    ...
    const-string/jumbo v3, "verifier_default_response"
    ...
    const-string v3, "data_stall_alarm_non_aggressive_delay_in_ms"
    ...
    const-string v3, "dropbox_age_seconds"
    ...
    const-string v3, "dropbox_quota_kb"
    ...
    const-string v3, "dropbox_quota_percent"
    ...
    const-string v3, "dropbox_reserve_percent"
    ...
    const-string/jumbo v3, "sys_free_storage_log_interval"
    ...
    const-string v3, "disk_free_change_reporting_threshold"
    ...
    const-string/jumbo v3, "sys_storage_threshold_percentage"
    ...
    const-string/jumbo v3, "sys_storage_threshold_max_bytes"
    ...
    const-string/jumbo v3, "set_install_location"
    ...
    const-string/jumbo v3, "read_external_storage_enforced_default"
    ...
    const-string/jumbo v3, "set_global_http_proxy"
    ...
    const-string/jumbo v3, "webview_data_reduction_proxy_key"
    ...
    const-string/jumbo v3, "parental_control_enabled"

    aput-object v3, v2, v8

    const-string/jumbo v3, "parental_control_redirect_url"
    ...
    const-string v4, "accessibility_display_magnification_scale"

    aput-object v4, v2, v3

    const/4 v3, 0x7

    const-string v4, "accessibility_display_magnification_auto_update"
    ...
    const-string/jumbo v4, "selected_spell_checker"

    aput-object v4, v2, v3

    const/16 v3, 0xb

    const-string/jumbo v4, "selected_spell_checker_subtype"

    aput-object v4, v2, v3

    sput-object v2, Landroid/provider/Settings$Secure;->CLONE_TO_MANAGED_PROFILE:[Ljava/lang/String;

    .line 6016
    const-string/jumbo v2, "ro.default_data_off"
    ...
    const-string/jumbo v2, "ro.mtk_gemini_support"
    ...
    :cond_1
    sput v0, Landroid/provider/Settings$Secure;->MOBILE_DATA_DEFAULT:I
...
.method public static getStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 4009
    const-string v0, "SettingsInterface"
...
.method public static putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v2, "set location mode, package name = "
