...
.method private enforceWritePermission(Ljava/lang/String;Landroid/net/Uri;Landroid/os/IBinder;)I
    ...
    invoke-virtual {v4, p2, p3}, Landroid/content/ContentProvider;->enforceWritePermissionInner(Landroid/net/Uri;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v5}, Landroid/content/ContentProvider;->getModifyPermission()Ljava/lang/String;

    move-result-object v5

    # invokes: Landroid/content/ContentProvider;->checkMoMSPermission(Ljava/lang/String;)Z
    invoke-static {v4, v5}, Landroid/content/ContentProvider;->access$200(Landroid/content/ContentProvider;Ljava/lang/String;)Z
    ...
    .line 529
    iget-object v3, p0, Landroid/content/ContentProvider$Transport;->mAppOpsManager:Landroid/app/AppOpsManager;
...
.method private hook_enforceReadPermission(Ljava/lang/String;Landroid/net/Uri;)I
    ...
    invoke-static {v0, p2, p1}, Landroid/content/ContentProvider$Injector;->isCurentLockApp(Landroid/content/ContentProvider;Landroid/net/Uri;Ljava/lang/String;)Z
...
.method private hook_enforceWritePermission_isDel(Ljava/lang/String;Landroid/net/Uri;)I
    ...
    invoke-static {v1, p2, p1}, Landroid/content/ContentProvider$Injector;->isCurentLockApp(Landroid/content/ContentProvider;Landroid/net/Uri;Ljava/lang/String;)Z
...
.method public applyBatch(Ljava/lang/String;Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult;
    ...
    .line 301
    invoke-static {p1, v6, v10}, Lmeizu/security/FlymePermissionManager;->checkReadPrivilege(Ljava/lang/String;Landroid/net/Uri;Z)Z
    ...
    invoke-static {v8, v6, p1}, Landroid/content/ContentProvider$Injector;->isCurentLockApp(Landroid/content/ContentProvider;Landroid/net/Uri;Ljava/lang/String;)Z
    ...
    .line 311
    invoke-static {p1, v6, v10}, Lmeizu/security/FlymePermissionManager;->checkWritePrivilege(Ljava/lang/String;Landroid/net/Uri;Z)Z
