...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/app/ActivityThread$ScrollCallbackData;,
        Landroid/app/ActivityThread$ScrollActivityData;,
...
# instance fields
.field public downConfig:Landroid/content/res/Configuration;
...
.field public upConfig:Landroid/content/res/Configuration;
...
.method constructor <init>()V
    ...
    .line 6164
    iput-object v1, p0, Landroid/app/ActivityThread;->upConfig:Landroid/content/res/Configuration;

    .line 6165
    iput-object v1, p0, Landroid/app/ActivityThread;->downConfig:Landroid/content/res/Configuration;
...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    const-string v4, "AT:handleBindApplication"
    ...
    const-string v4, "AT:Enter callApplicationOnCreate"
    ...
    const-string v4, "AT:Leave callApplicationOnCreate"
    ...
    const-string v4, "AT:Leave AT:handleBindApplication"
...
.method private handleLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)V
    ...
    const-string v6, "AT:handleLaunchActivity"

    invoke-static {v3, v6}, Landroid/debug/DebugUtils;->logAppLunch(Ljava/lang/String;Ljava/lang/String;)V
...
.method private handlePauseActivity(Landroid/os/IBinder;ZZIZ)V
    ...
    const-string v2, "AT:handlePauseActivity"
...
.method private installContentProviders(Landroid/content/Context;Ljava/util/List;)V
    ...
    .line 5048
    const-string v0, "handleInstallProvider"
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    const-string v5, "AT:performLaunchActivity"
...
.method private updateVisibility(Landroid/app/ActivityThread$ActivityClientRecord;Z)V
    ...
    .line 3789
    iget v1, p1, Landroid/app/ActivityThread$ActivityClientRecord;->splitmode:I

    if-ne v1, v2, :cond_2

    iget-object v1, p0, Landroid/app/ActivityThread;->upConfig:Landroid/content/res/Configuration;
    ...
    iget-object v2, p0, Landroid/app/ActivityThread;->upConfig:Landroid/content/res/Configuration;
    ...
    iget-object v1, p0, Landroid/app/ActivityThread;->downConfig:Landroid/content/res/Configuration;
    ...
    iget-object v2, p0, Landroid/app/ActivityThread;->downConfig:Landroid/content/res/Configuration;
...
.method collectAndPerformSplitConfigurationChanged(ZLandroid/content/res/Configuration;)V
    .locals 12
    ...
    .line 6192
    .local v6, "callbacksUp":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/ComponentCallbacks2;>;"
    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    .line 6194
    .local v4, "callbacksDown":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/ComponentCallbacks2;>;"
    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    .line 6196
    .local v5, "callbacksOthers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/ComponentCallbacks2;>;"
    ...
    iget v9, v3, Landroid/app/ActivityThread$ActivityClientRecord;->splitmode:I

    const/4 v11, 0x1

    if-ne v9, v11, :cond_3

    iget-object v9, p0, Landroid/app/ActivityThread;->upConfig:Landroid/content/res/Configuration;

    if-eqz v9, :cond_3

    .line 6202
    iget-object v9, v3, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;
    ...
    iget-boolean v9, v3, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z
    ...
    iput-object v9, v3, Landroid/app/ActivityThread$ActivityClientRecord;->newConfig:Landroid/content/res/Configuration;
    ...
    .line 6207
    .restart local v1    # "NACT":I
    .restart local v2    # "a":Landroid/app/Activity;
    .restart local v3    # "ar":Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    iget-object v9, p0, Landroid/app/ActivityThread;->downConfig:Landroid/content/res/Configuration;
    ...
    iget-object v11, v3, Landroid/app/ActivityThread$ActivityClientRecord;->packageInfo:Landroid/app/LoadedApk;
    ...
    .line 6220
    iput-object v8, v3, Landroid/app/ActivityThread$ActivityClientRecord;->newConfig:Landroid/content/res/Configuration;
    ...
    iget-object v10, p0, Landroid/app/ActivityThread;->upConfig:Landroid/content/res/Configuration;
    ...
    iget-object v10, p0, Landroid/app/ActivityThread;->downConfig:Landroid/content/res/Configuration;
    ...
    invoke-static {v9, p2}, Landroid/app/ActivityThread;->performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/content/res/Configuration;)V
...
.method collectComponentCallbacks(ZLandroid/content/res/Configuration;)Ljava/util/ArrayList;
    ...
    iget v9, v5, Landroid/app/ActivityThread$ActivityClientRecord;->splitmode:I
...
.method getTopLevelResources(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/app/LoadedApk;)Landroid/content/res/Resources;
    ...
    .line 1960
    .local v9, "flymeRes":Landroid/content/res/Resources;
    if-eqz v9, :cond_0

    .line 1961
    invoke-virtual/range {p7 .. p7}, Landroid/app/LoadedApk;->getPackageName()Ljava/lang/String;
...
.method final handleActivityConfigurationChanged(Landroid/os/IBinder;)V
    ...
    .line 4578
    :cond_1
    iget v1, v0, Landroid/app/ActivityThread$ActivityClientRecord;->splitmode:I
...
.method final handleActivitySetSplitMode(Landroid/os/IBinder;I)V
    .locals 2
    .param p1, "token"    # Landroid/os/IBinder;
    ...
    .line 6176
    iput p2, v0, Landroid/app/ActivityThread$ActivityClientRecord;->splitmode:I
...
.method final handleActivitySplitModeExit(Landroid/os/IBinder;)V
    .locals 2
    .param p1, "token"    # Landroid/os/IBinder;
    ...
    invoke-virtual {v1}, Landroid/app/Activity;->onSplitModeExit()V
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .end local v3    # "i":I
    :cond_5
    invoke-virtual {p0, v6, p1}, Landroid/app/ActivityThread;->collectAndPerformSplitConfigurationChanged(ZLandroid/content/res/Configuration;)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZZ)V
    ...
    .prologue
    .line 3370
    const-string v7, "38-0"

    const-string v8, "AT:Enter handleResumeActivity"
    ...
    .line 3436
    iget v7, v4, Landroid/app/ActivityThread$ActivityClientRecord;->splitmode:I

    const/4 v8, 0x1

    if-ne v7, v8, :cond_e

    iget-object v7, p0, Landroid/app/ActivityThread;->upConfig:Landroid/content/res/Configuration;
    ...
    iget-object v8, p0, Landroid/app/ActivityThread;->upConfig:Landroid/content/res/Configuration;
    ...
    const-string v8, "AT:Leave handleResumeActivity"
    ...
    iget-object v7, p0, Landroid/app/ActivityThread;->downConfig:Landroid/content/res/Configuration;
    ...
    iget-object v8, p0, Landroid/app/ActivityThread;->downConfig:Landroid/content/res/Configuration;
...
.method final handleScrollActivity(Landroid/app/ActivityThread$ScrollActivityData;)V
    .locals 3
    .param p1, "data"    # Landroid/app/ActivityThread$ScrollActivityData;
    ...
    .line 6291
    iget-object v1, p1, Landroid/app/ActivityThread$ScrollActivityData;->token:Landroid/os/IBinder;
    ...
    .line 6293
    iget-object v1, p1, Landroid/app/ActivityThread$ScrollActivityData;->event:[Landroid/view/MotionEvent;

    iget v2, p1, Landroid/app/ActivityThread$ScrollActivityData;->value:I
...
.method final handleSetScrollActivityCallback(Landroid/app/ActivityThread$ScrollCallbackData;)V
    .locals 2
    .param p1, "data"    # Landroid/app/ActivityThread$ScrollCallbackData;
    ...
    .line 6300
    iget-object v1, p1, Landroid/app/ActivityThread$ScrollCallbackData;->token:Landroid/os/IBinder;
    ...
    .line 6302
    iget-object v1, p1, Landroid/app/ActivityThread$ScrollCallbackData;->callback:Landroid/app/IScrollActivityCallback;

    invoke-virtual {v0, v1}, Landroid/app/Activity;->setScrollActivityCallback(Landroid/app/IScrollActivityCallback;)V
...
.method handleShrinkMemory(I)V
    ...
    .line 6251
    const-string v3, "handleShrinkMemory"
...
.method final handleUpdateSplitConfig([Landroid/content/res/Configuration;)V
    .locals 2
    .param p1, "configs"    # [Landroid/content/res/Configuration;
    ...
    iput-object v0, p0, Landroid/app/ActivityThread;->upConfig:Landroid/content/res/Configuration;
    ...
    iput-object v0, p0, Landroid/app/ActivityThread;->downConfig:Landroid/content/res/Configuration;
