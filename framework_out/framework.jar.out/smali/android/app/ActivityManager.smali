...
.field public static final EXCHANGE_SPLIT_ACTIVITY:I = 0x3

.field public static final EXIT_SPLIT_MODE:I = 0x6

.field public static final IME_CHANGED:I = 0x8
...
.field public static final SET_SPLIT_MODE:I = 0x1

.field public static final SHOW_WP_FOR_SPLIT:I = 0x5

.field public static final SPLIT_A:I = 0x1

.field public static final SPLIT_B:I = 0x2

.field public static final SPLIT_NONE:I = 0x0
...
.field public static final START_PERMISSION_USER_DENIED:I = -0x8
...
.field public static final UPDATE_SPLIT_LOC:I = 0x2

.field public static final UPDATE_SPLIT_LOC_WITHOUT_LAYOUT:I = 0x7

.field public static final UPDATE_SPLIT_SHOWN:I = 0x4
...
.method public excuteSplitManagerCmd(II)V
    .locals 1
    .param p1, "cmd"    # I
    .param p2, "data"    # I
    ...
    invoke-interface {v0, p1, p2}, Landroid/app/IActivityManager;->excuteSplitManagerCmd(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public forceFreezePackage(Ljava/lang/String;)V
    .locals 1
    .param p1, "packageName"    # Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/ActivityManager;->forceFreezePackageAsUser(Ljava/lang/String;I)V

    .line 2902
    return-void
.end method

.method public forceFreezePackageAsUser(Ljava/lang/String;I)V
    .locals 1
    .param p1, "packageName"    # Ljava/lang/String;
    .param p2, "userId"    # I
    ...
    invoke-interface {v0, p1, p2}, Landroid/app/IActivityManager;->forceFreezePackage(Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public forceUnfreezePackage(Ljava/lang/String;)V
    .locals 1
    .param p1, "packageName"    # Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/ActivityManager;->forceUnfreezePackageAsUser(Ljava/lang/String;I)V

    .line 2923
    return-void
.end method

.method public forceUnfreezePackageAsUser(Ljava/lang/String;I)V
    .locals 1
    .param p1, "packageName"    # Ljava/lang/String;
    .param p2, "userId"    # I
    ...
    invoke-interface {v0, p1, p2}, Landroid/app/IActivityManager;->forceUnfreezePackage(Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public freezeRegisterListener(Landroid/os/freeze/FlymeFreezeListener;)V
    .locals 1
    .param p1, "listener"    # Landroid/os/freeze/FlymeFreezeListener;
    ...
    invoke-interface {v0, p1}, Landroid/app/IActivityManager;->freezeRegisterListener(Landroid/os/freeze/IFlymeFreezeListener;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public moveTaskToFrontWithResult(IILandroid/os/Bundle;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/app/IActivityManager;->moveTaskToFrontWithResult(IILandroid/os/Bundle;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public removeTaskNotKillProcess(I)Z
    ...
    invoke-interface {v1, p1}, Landroid/app/IActivityManager;->removeTaskNotKillProcess(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
