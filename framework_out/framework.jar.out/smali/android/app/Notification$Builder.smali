...
.field private mReplyIntent:Landroid/app/PendingIntent;
...
.field private mSnoozeIntent:Landroid/app/PendingIntent;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2165
    invoke-direct {p0}, Landroid/app/Notification$Builder;->initNotificationBuilderExt()V
...
.method private applyStandardTemplateFlyme(Landroid/app/Notification$Builder;Landroid/app/NotificationBuilderExt;Landroid/widget/RemoteViews;)V
    ...
    invoke-virtual {p3, v6, v0}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    .line 3735
    invoke-virtual {p3, v6, v3}, Landroid/widget/RemoteViews;->setViewVisibility(II)V
    ...
    invoke-virtual {p3, v2, v0}, Landroid/widget/RemoteViews;->setImageViewResource(II)V
    ...
    invoke-virtual {p3, v5, v0}, Landroid/widget/RemoteViews;->setImageViewResource(II)V
    ...
    .line 3762
    :cond_7
    invoke-virtual {p3, v5, v4}, Landroid/widget/RemoteViews;->setViewVisibility(II)V
...
.method private buildUnstyledFlyme(Landroid/app/Notification;Landroid/app/NotificationBuilderExt;)V
    .locals 2
    .param p1, "dst"    # Landroid/app/Notification;
    .param p2, "builder"    # Landroid/app/NotificationBuilderExt;

    .prologue
    .line 3783
    iget-object v0, p1, Landroid/app/Notification;->mFlymeNotification:Landroid/app/NotificationExt;

    iget v1, p2, Landroid/app/NotificationBuilderExt;->mInternalApp:I
    ...
    iget v1, p2, Landroid/app/NotificationBuilderExt;->mNotificationIcon:I
    ...
    iget-object v1, p2, Landroid/app/NotificationBuilderExt;->mNotificationBitmapIcon:Landroid/graphics/Bitmap;
    ...
    iget v1, p2, Landroid/app/NotificationBuilderExt;->mSimSlot:I
    ...
    iget-object v1, p2, Landroid/app/NotificationBuilderExt;->mIconIntent:Landroid/app/PendingIntent;
    ...
    iget v1, p2, Landroid/app/NotificationBuilderExt;->mProgressBarDrawable:I
    ...
    iget-boolean v1, p2, Landroid/app/NotificationBuilderExt;->mIsCircleProgressBar:Z
    ...
    iget v1, p2, Landroid/app/NotificationBuilderExt;->mCircleProgressBarColor:I
    ...
    iget v1, p2, Landroid/app/NotificationBuilderExt;->mCircleProgressRimColor:I
...
.method private getBaseLayoutResource()I
    ...
    .prologue
    .line 3676
    invoke-direct {p0}, Landroid/app/Notification$Builder;->getBaseLayoutResourceFlyme()I
...
.method private initNotificationBuilderExt()V
    .locals 1
...
.method private restoreFromNotification(Landroid/app/Notification;)V
    ...
    .line 3570
    iget-object v1, p1, Landroid/app/Notification;->snoozeIntent:Landroid/app/PendingIntent;

    iput-object v1, p0, Landroid/app/Notification$Builder;->mSnoozeIntent:Landroid/app/PendingIntent;

    .line 3573
    iget-object v1, p1, Landroid/app/Notification;->replyIntent:Landroid/app/PendingIntent;

    iput-object v1, p0, Landroid/app/Notification$Builder;->mReplyIntent:Landroid/app/PendingIntent;
...
.method public buildUnstyled()Landroid/app/Notification;
    ...
    .line 3310
    iget-object v1, p0, Landroid/app/Notification$Builder;->mSnoozeIntent:Landroid/app/PendingIntent;

    iput-object v1, v0, Landroid/app/Notification;->snoozeIntent:Landroid/app/PendingIntent;

    .line 3313
    iget-object v1, p0, Landroid/app/Notification$Builder;->mReplyIntent:Landroid/app/PendingIntent;

    iput-object v1, v0, Landroid/app/Notification;->replyIntent:Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v0, v1}, Landroid/app/Notification$Builder;->buildUnstyledFlyme(Landroid/app/Notification;Landroid/app/NotificationBuilderExt;)V
...
.method public setReplyIntent(Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 2382
    iput-object p1, p0, Landroid/app/Notification$Builder;->mReplyIntent:Landroid/app/PendingIntent;
...
.method public setSnoozeIntent(Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 2376
    iput-object p1, p0, Landroid/app/Notification$Builder;->mSnoozeIntent:Landroid/app/PendingIntent;
